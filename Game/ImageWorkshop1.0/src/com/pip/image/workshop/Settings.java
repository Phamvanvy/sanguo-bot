...
public class Settings {
	...
	public static String pvrTexTool = "PVRTexTool.exe";
	public static String etcTool = "etc1tool.exe";
	...
	public static int animateFrameDelay = 80;
	public static int screenWidth5800 = 360;
	public static int screenHeight5800 = 640;
	public static int screenWidthAndroid = 533;//安卓客户端把地图放大1.5倍，800/1.5
	public static int screenHeightAndroid = 320;//安卓客户端把地图放大1.5倍，480/1.5
	...
	public static void loadSetting() {
		...
		try {
			...
			pvrTexTool = props.getProperty("pvrtextool", "PVRTexTool.exe");
			etcTool = props.getProperty("etctool", "etc1tool.exe");
			screenWidth = Integer.parseInt(props.getProperty("screen_width", "240"));
			screenHeight = Integer.parseInt(props.getProperty("screen_height", "320"));
			animateFrameDelay = Integer.parseInt(props.getProperty("animate_frame_delay", "80"));
		} catch (IOException e) {
		} finally {
			if (fis != null) {
				try {
...
//			}
	...
	public static void saveSetting() {
		...
		try {
			...
			props.setProperty("pvrtextool", pvrTexTool);
			props.setProperty("etctool", etcTool);
			props.setProperty("screen_width", String.valueOf(screenWidth));
			props.setProperty("screen_height", String.valueOf(screenHeight));
			props.setProperty("animate_frame_delay", String.valueOf(animateFrameDelay));
