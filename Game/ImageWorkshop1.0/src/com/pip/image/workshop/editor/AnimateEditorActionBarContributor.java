...
public class AnimateEditorActionBarContributor extends EditorActionBarContributor implements IPartListener, IPropertyListener, IPropertyChangeListener {
	private AnimateEditor activeEditor;
	...
	public void partActivated(IWorkbenchPart part) {
		if (part instanceof AnimateEditor) {
			activeEditor = (AnimateEditor)part;
