...
public class ParabolaPath implements PipParticlePath {
	...
	private static String[] PARAM_NAMES = {
		"投射速度", "投射速度随机范围", "加速度", "重力加速度", "投射角度", "投射角度随机范围"
	};
	...
	public int[][] makePath(int x, int y, int liveTime, Random rand) {
		...
		double xspeed = currentSpeed * Math.cos(currentAngle);
		double yspeed = -currentSpeed * Math.sin(currentAngle);
	...
	public PipParticlePath dup() {
		ParabolaPath ret = new ParabolaPath();
		ret.speed = speed;
