...
public class WorkshopPlugin extends AbstractUIPlugin {
    public static int screenWidth = 176, screenHeight = 208;
    ...
    private final static String[] imageNames = { 
        "mainGroup", "groupFolder","folder", "image", "disk", "palette", "animate", "systemimage", "tilelib", "map", "cellmap", "landform","grid","tiles"
    };
