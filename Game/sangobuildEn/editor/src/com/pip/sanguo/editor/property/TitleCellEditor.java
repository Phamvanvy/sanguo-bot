 ...
 * ³ÆºÅÑ¡Ôñ¡£
 */
public class TitleCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int titleID;

    public TitleCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                TitleCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        titleID = ((Integer)value).intValue();
        text.setText(Title.toString(EditorApplication.getProj(), titleID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != TitleCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseTitleDialog dlg = new ChooseTitleDialog(text.getShell());
