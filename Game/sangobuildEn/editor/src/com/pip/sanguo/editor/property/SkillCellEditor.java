 ...
 * ¼¼ÄÜÑ¡Ôñ¡£
 */
public class SkillCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int skillID;

    public SkillCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                SkillCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        skillID = ((Integer)value).intValue();
        text.setText(SkillConfig.toString(EditorApplication.getProj(), skillID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != SkillCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseSkillDialog dlg = new ChooseSkillDialog(text.getShell());
