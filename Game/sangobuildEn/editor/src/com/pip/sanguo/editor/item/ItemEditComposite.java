...
public class ItemEditComposite extends Composite  implements ISelectionChangedListener,SelectionListener{
    ...
    public static final String[] COMBO_TYPES = { "普通物品", "技能书", "坐骑", "坐骑口粮", "称号", "材料", "打造配方", "宝石", "补给", "杂物", "精炼" };
    public static final int[] TYPE_MAP = { Item.TYPE_NORMAL, Item.TYPE_SKILLBOOK, Item.TYPE_HORSE, Item.TYPE_HORSEFOOD, Item.TYPE_TITLE, Item.TYPE_MATERIAL, Item.TYPE_FORMULA, Item.TYPE_JEWEL, Item.TYPE_RENEW, Item.TYPE_MISC, Item.TYPE_REFINE };
