 ...
 * µôÂä×éÑ¡Ôñ¡£
 */
public class DropGroupCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int dropGroupID;

    public DropGroupCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                DropGroupCellEditor.this.focusLost();
            }
        });
    ...
    protected Object doGetValue() {
        return new Integer(dropGroupID);
    }
    ...
    protected void doSetValue(Object value) {
        ...
        dropGroupID = ((Integer)value).intValue();
        text.setText(DropGroup.toString(EditorApplication.getProj(), dropGroupID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != DropGroupCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseDropGroupDialog2 dlg = new ChooseDropGroupDialog2(text.getShell());
        dlg.setSelectedDropGroup(dropGroupID);
        if (dlg.open() == Dialog.OK) {
            dropGroupID = dlg.getSelectedDropGroup();
            text.setText(DropGroup.toString(EditorApplication.getProj(), dropGroupID));
            fireApplyEditorValue();
            deactivate();
        }
