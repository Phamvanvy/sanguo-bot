 ...
 * Sound—°‘Ò°£
 */
public class SoundCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int soundID;

    public SoundCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                SoundCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        soundID = ((Integer)value).intValue();
        text.setText(Sound.toString(EditorApplication.getProj(), soundID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != SoundCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseSoundDialog dlg = new ChooseSoundDialog(text.getShell());
        dlg.setSelectedSound(soundID);
        if (dlg.open() == Dialog.OK) {
            soundID = dlg.getSelectedSound();
            text.setText(Sound.toString(EditorApplication.getProj(), soundID));
            fireApplyEditorValue();
            deactivate();
        }
