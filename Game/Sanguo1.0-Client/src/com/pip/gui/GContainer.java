...
//			int offsetX = 0;
			int offsetY = 0;
			//#if NewUI2
			if(firstInViewIndex == -1 || lastInViewIndex == -1){
...
//#endif
			...
			if(gWidget instanceof GContainer && gWidget.isShow) {
				//#if NewUI2
				//# if(Tool.rectIn(gWidget.vmData[GW_VM_XX], gWidget.vmData[GW_VM_YY], gWidget.vmData[GW_VM_W], gWidget.vmData[GW_VM_H], x, y)
				//# 		|| gWidget.vmData[GW_VM_W] == 0 || gWidget.vmData[GW_VM_H] == 0) {
				//#endif
					GContainer gContainer = ((GContainer)gWidget);
