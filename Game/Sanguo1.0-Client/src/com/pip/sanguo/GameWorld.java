...
public class GameWorld implements IVMGameProcessor{
    ...
    // 记录所有move包，move包放在GameMain.run里根据性能动态处理
...
//#endif
    ...
    public static void moveMap(){
        ...
        //#if NewUI2
        //10.22
        //# viewX = (short)(player.sprite.getX() - (GameView.showWidth >> 1));
        ...
        //#if NewUI2
        //# int viewMaxX = (short)((currentMap.width - GameView.showWidth) & 0xFFFF);
        //# int viewMaxY = (short)((currentMap.height - GameView.showHeight) & 0xFFFF);
        //#else
...
//                break;
            ...
            // GetFile包放到ResourceAsyncLoader里处理
            // Move包放到GameMain.run里处理
