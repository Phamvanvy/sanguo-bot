...
public class TongService implements Service, ServiceEventListener {
	 ...
	 * 帮派职务名称。
	 */
	public static final String[] DUTY_NAMES = { "军士", "参军", "副将", "都督" }; 
	...
	public void join(int inviteID, int oper) throws TongException {
		...
		if(p!=null){
			...
			.sendGuildSystemMessage(MessageFormat.format("{0}加入军团", p.name),invite.tong.id);
