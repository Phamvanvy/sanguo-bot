...
public class MarriageCall extends ClientSessionAsyncCall {
	...
	public void callFinish() throws Exception {
		...
		if(success){
			...
			chatService.addChatMessage(new ChatMessage(ChatOption.FACTION,-1,person.faction,"系统",person.faction,MessageFormat.format("{0}和{1}已结婚，大家一起祝福他们.", person.name,annotherPerson.name),null));
		}else{
			Packet p1 = new Packet(OpCode.MARRIAGE_SERVER);
