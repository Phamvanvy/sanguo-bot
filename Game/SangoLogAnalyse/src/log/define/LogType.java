...
public class LogType {
	...
	public static final LogType loadType(LogDefine define,SubnodeConfiguration node){
		...
		List<SubnodeConfiguration> list = node.configurationsAt("repalcedata");
		for(SubnodeConfiguration l : list){
			ReplaceData replaceData = new ReplaceData(l.getString("regex"), l.getString("replace"));
