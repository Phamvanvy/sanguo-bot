	...
	private void processGoMap(VMap map, Player player){
		if(map!=null && player!=null){
			...
			if(targetIndex>-1 && lastMapId==sourceMapId[targetIndex] && currentMapId==targetMapId[targetIndex]){
				...
				String content = "Tân binh nhận phần thưởng liên tiếp, chúc mừng bạn nhận được 1h x2 kinh nghiệm và tăng lực tấn công, mau đi rèn luyện cho bản thân đi!";
