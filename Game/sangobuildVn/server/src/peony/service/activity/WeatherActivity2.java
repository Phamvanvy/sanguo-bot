							...
							try{
								if (NATION_BATTLE_WIN_FACTION > 0) {
									...
									String msg = MessageFormat.format(
											"{0} nhận được chiến thắng lần quốc chiến này, họ ở {1} nhận được 60 phút phần thưởng mưa chiến công.",
									...
									String msg2 = MessageFormat.format(
											"Dưới nỗ lực nhân dân cả nước, chúng ta đã chiến thắng quốc chiến lần này, chúng ta cùng tận hưởng mưa chiến công ở  {0}.",mapNames);
									Server.server
									.getServiceRegistry()
									.getChatService()
