...
public class ModelService implements Service {
    ...
    static {
        modelInputTypeMap.put("GenericMidp2", new ModelInputType(1, 0));
        ...
        modelInputTypeMap.put("Lenovo", new ModelInputType(0, 1));
        modelInputTypeMap.put("NokiaS60V3", new ModelInputType(1, 0));
        modelInputTypeMap.put("NokiaS60V2", new ModelInputType(1, 0));
        modelInputTypeMap.put("Android", new ModelInputType(0, 1));
        modelInputTypeMap.put("AndroidLarge", new ModelInputType(0, 1));
        modelInputTypeMap.put("AndroidSmall", new ModelInputType(0, 1));
        modelInputTypeMap.put("PocketPC", new ModelInputType(0, 1));
        modelInputTypeMap.put("WindowsMobile", new ModelInputType(0, 1));
        modelInputTypeMap.put("iPhone", new ModelInputType(0, 1));
        modelInputTypeMap.put("iPhone4", new ModelInputType(0, 1));
        modelInputTypeMap.put("iPad", new ModelInputType(0, 1));
        modelInputTypeMap.put("LenovoU1", new ModelInputType(0, 1));
    }
    ...
    protected void loadConfig() throws Exception {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (!found) {
                throw new Exception(MessageFormat.format("机型配置错误，配置不存在：{0}", configID));
            }
            marr.add(model);
