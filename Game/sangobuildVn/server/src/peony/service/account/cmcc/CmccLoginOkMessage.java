...
public class CmccLoginOkMessage extends LegacyLoginOkMessage {
	...
	public CmccLoginOkMessage(int serial, int accountId, String name,
			...
			int[] purchasedCodes, String cityName) {
		super(serial, accountId, cityName, key, phone, modifiedNameTimes,
				iMoney, isMonth, isSubscribe, loginErrorTimes, purchasedCodes);
