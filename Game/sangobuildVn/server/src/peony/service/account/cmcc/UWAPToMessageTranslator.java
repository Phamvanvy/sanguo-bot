...
public class UWAPToMessageTranslator {
    ...
    */
    ...
    protected IMessage accountLoginOk(UWAPData data) throws Exception{
    	...
    	CmccLoginOkMessage message = new CmccLoginOkMessage(serial,accountId,name,"",phone,mpTimes,imoney,false,false,0,new int[]{},cityName);
    	return message;
    }
    ...
    protected IMessage ibuyResult(UWAPData data) throws Exception{
    	...
    	String msg = data.readString();
    	return new LegacyBuyResultMessage(serial,result,balance,cost,msg);
    }
