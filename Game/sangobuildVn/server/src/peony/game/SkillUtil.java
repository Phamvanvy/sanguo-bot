...
public class SkillUtil {
	...
	private static final String[] MANA_STRING = {"<c008242>气力+\n<c008242> khí lực +","<c008242>气力+\n<c008242> khí lực +","Tinh lực","Tinh lực"};
	...
	public static String getSkillDesc(Skill skill, Unit owner){
		...
		if ((skill.getType() & (Skill.TYPE_PASSIVE | Skill.TYPE_BUFF)) == 0) {
		    ...
		    if (dist > 0) {
		        sb.append("Khoảng cách có hiệu quả");
		    ...
		    sb.append(mana);
            sb.append("Điểm, thời gian làm lạnh ");
