...
import peony.npc.service.PloyMapVMapManager;
...
public class Server implements Runnable{
    ...
    public static String iMoneyStoreString = "i Tệ mại trường";
...
//		}
	...
	private void testDrop(int monsterID, int playerLevel, int times) {
        ...
        System.out.println("Cấp độ quái vật" + c.level + "Cấp độ người chơi" + playerLevel);
        System.out.println("Thời gian dùng: " + (System.currentTimeMillis() - time));
