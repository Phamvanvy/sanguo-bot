...
public class GetJewelConfigCall extends ClientSessionAsyncCall {
	...
	public synchronized static void checkConfigPacket() {
		if (pt == null) {
			try {
				pt = new Packet(OpCode.DECORATE_GET_CONFIG_SERVER);
		        ...
		        pt.putInt(getItemPrice(js.deocrateItem1.id));
		        ...
		        pt.putInt(getItemPrice(js.deocrateItem2.id));
