...
public class AdminPlayerRelationCall extends ClientSessionAsyncCall {
	...
	public void callFinish() throws Exception {
		if (relation != null) {
			...
			ErrorHandler.sendAdminErrorMessage(session, serial, OpCode.ADMIN_GM_PLAYER_RELATION, MessageFormat.format("Không tìm thấy quan hệ xã hội với người chơi chỉ định: {0}.", playerId));
		}
	}
