...
public abstract class GameSprite implements IAnimateCallback, IAnimateOwner, IVMGameProcessor{
    ...
    public void vm_sprite_adjust_animate_dir(int _targetInstanceId, boolean _setAnimate){
        ...
        if(targetSprite != null){
            int[] newDir = Tool.calulateDirWithWayPointMatrix(sprite.getDir(), sprite.getAnimateSubDir(), sprite.getX(), sprite.getY(), targetSprite.sprite.getX(), targetSprite.sprite.getY());
            if(!sprite.getMove()) {
