...
public class GameWorld implements IVMGameProcessor{
    ...
    public static void moveMap(){
        ...
        //#if ModelID == Android
        //# int nShortcutBkgWidth = Tool.getGlobalInt("ShortcutBkgWidth");
        //# int viewMaxX = (short)((currentMap.width - (GameMain.viewWidth - 38)) & 0xFFFF);
        //#elif ModelID == AndroidAuto
        //# int nShortcutBkgWidth = 0;
        //# int viewMaxX = 0;
        //# if (GameMain.getUIModel().equals(GameMain.ANDROID_NORMAL))
    	//# {
    	//# nShortcutBkgWidth = Tool.getGlobalInt("ShortcutBkgWidth");   	
        //# viewMaxX = (short)((currentMap.width - (GameMain.viewWidth - 38)) & 0xFFFF);
        //# }
        //# else
        //# {
        //# viewMaxX = (short)((currentMap.width - GameMain.viewWidth) & 0xFFFF);	
        //# }
        //#else
