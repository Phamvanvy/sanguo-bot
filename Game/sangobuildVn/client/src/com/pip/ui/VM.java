...
//# import com.pip.android.ZhifuBaoActivity;  
            ...
            case 0x6500: //0x6500=void ConfirmExit()
            {
            	if(!(GameMain.display.getCurrent() instanceof Alert)){
            		synchronized(this) {            			
    					isExit = true;
    		//#if Revision == TAIWAN 
	    			//# Alert alert = new Alert("提示", "確認要退出遊戲嗎？", null, AlertType.INFO);
	                //# alert.setCommandListener(VM.this);
	                //# alert.addCommand(new Command("確認", Command.OK, 0));
    	     //#else
...
//#endif          	
    ...
    public void commandAction(Command cmd, Displayable d){
		...
		VMGame mainmenu;
		//#if Revision == TAIWAN 
		//# if (isExit && "確認".equals(cmd.getLabel())) {
		//#else
