...
public class MessageDecoder implements IMessageDecoder {
	...
	protected AddBalanceMessage getAddBalanceMessage(UWAPData data) throws Exception{
		AddBalanceMessage msg = new AddBalanceMessage(data.getSerial(),data.readInt(),data.readInt(),data.readString());
		return msg;
	}
	...
	public UseIMoneyCardOkMessage getUseIMoneyCardOkMessage(UWAPData data) throws Exception {
		return new UseIMoneyCardOkMessage(data.getSerial(), data.readInt(), data.readInt(), data.readInt());
	}

	public UseIMoneyCardMessage getUseIMoneyCardMessage(UWAPData data) throws Exception {
		return new UseIMoneyCardMessage(data.getSerial(), data.readString(), data.readInt(), data.readString(), data.readString(), data.readString());
	}
	
	public CreateIMoneyCardOkMessage getCreateIMoneyCardOkMessage(UWAPData data) throws Exception {
		return new CreateIMoneyCardOkMessage(data.getSerial(), data.readInt(), data.readInt(), data.readInt(), data.readString(), data.readString());
	}
	...
	protected _DecBalanceOkMessage get_DecIMoneyOkMessage(UWAPData data) throws Exception{
		_DecBalanceOkMessage msg = new _DecBalanceOkMessage(data.getSerial(),data.readInt(),data.readInt());
		return msg;
	}
	...
	protected SyncBalanceMessage getSyncBalanceMessage(UWAPData data) throws Exception{
		SyncBalanceMessage msg = new SyncBalanceMessage(data.getSerial(),data.readInt(),data.readInt(),data.readBoolean(),data.readBoolean());
		return msg;
	}
	...
	protected LegacyBuy1Message getLegacyBuy1Message(UWAPData data) throws Exception{
		LegacyBuy1Message msg = new LegacyBuy1Message(data.getSerial(),data.readInt(),data.readString(),data.readInt());
		return msg;
	}
	
	protected LegacyLoginOkMessage getLegacyLoginOkMesssage(UWAPData data) throws Exception {
		LegacyLoginOkMessage msg = new LegacyLoginOkMessage(data.getSerial(),
				data.readInt(), data.readString(), data.readString(), data
						...
						.readBoolean(), data.readBoolean(), data.readInt(),data.readInts());
		return msg;
	}
	...
	protected LegacyBuyResultMessage getLegacyBuyResultMessage(UWAPData data)
		...
		LegacyBuyResultMessage msg = new LegacyBuyResultMessage(data
				...
				.readInt(), data.readString());
		return msg;
	}
	
	protected LegacyBuyMessage getLegacyBuyMessage(UWAPData data) throws Exception{
		LegacyBuyMessage msg = new LegacyBuyMessage(data.getSerial(),data.readString(),data.readString(),data.readInt());
		return msg;
	}
	
	protected _BuyOkMessage get_ModifyIMoneyOkMessage(UWAPData data) throws Exception{
		_BuyOkMessage msg = new _BuyOkMessage(data.getSerial(),data.readInt(),data.readInt());
		return msg;
	}
	
	protected _BuyMessage get_ModifyIMoneyMessage(UWAPData data) throws Exception{
		_BuyMessage msg = new _BuyMessage(data.getSerial(),data.readString(),data.readString(),data.readInt());
		return msg;
	}
	...
	protected LegacyLoginMessage getLegacyLoginMessage(UWAPData data) throws Exception{
		...
		LegacyLoginMessage msg = new LegacyLoginMessage(serial, name, pass, phone);
		return msg;
	}
	...
	protected _LegacyLoginOkMessage get_LegacyLoginOkMessage(UWAPData data)
		...
		_LegacyLoginOkMessage msg = new _LegacyLoginOkMessage(data.getSerial(),data.readInt(),
				data.readString(), data.readString(), data.readString(), data
						.readInt(), data.readInt(), data.readInt(),data.readInts());
		return msg;
	}
