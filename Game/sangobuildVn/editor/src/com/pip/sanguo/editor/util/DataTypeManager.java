...
public class DataTypeManager {
    ...
    public static final Class[] editableClasses = { 
        ...
        GiftGroup.class, Shop.class, SuiteConfig.class, Title.class, Formula.class,
        Item.class, DropGroup.class, SkillConfig.class, Equipment.class, 
        BuffConfig.class, HorseType.class, TeleportSet.class, Sound.class,Card.class, Recast.class, TalismanType.class
    };
    // 存储各数据类型对应的编辑器ID
