 ...
 * µØµã±à¼­Æ÷¡£
 */
public class LocationCellEditor extends CellEditor {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                LocationCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        location = (int[])value;
        text.setText(GameMapInfo.locationToString(EditorApplication.getProj(), location, false));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != LocationCellEditor.class;
    }
