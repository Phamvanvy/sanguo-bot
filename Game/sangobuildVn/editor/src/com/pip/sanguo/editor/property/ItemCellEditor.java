...
public class ItemCellEditor extends CellEditor {
    ...
    public ItemCellEditor(Composite parent) {
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != ItemCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseItemDialog dlg = new ChooseItemDialog(text.getShell());
