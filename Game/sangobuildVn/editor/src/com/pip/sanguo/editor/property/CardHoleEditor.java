...
public class CardHoleEditor extends CellEditor {
    ...
    public CardHoleEditor(Composite parent) {
    ...
    protected void doSetValue(Object value) {
        ...
        if(((Integer)value).intValue() != cardId){
        	cardId = ((Integer)value).intValue();
        }
        Card card = EditorApplication.getProj().findCard(cardId);
        if(card != null){
        	text.setText(String.valueOf(card.holeId));
        }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != CardHoleEditor.class;
    }
    ...
    protected void editText() {
        ChooseCardDialog dlg = new ChooseCardDialog(text.getShell());
        ...
        if (dlg.open() == Dialog.OK) {
            ...
            if(item != null){       
                text.setText(String.valueOf(item.holeId));
            }
            else{
                text.setText("ÎÞÐ§¿¨Î»");
            }
