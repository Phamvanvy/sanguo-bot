 ...
 * ¼¼ÄÜÑ¡Ôñ¡£
 */
public class SkillSetCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected String skillIDs;

    public SkillSetCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                SkillSetCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        skillIDs = (String)value;
        text.setText(SkillConfig.toString(EditorApplication.getProj(), skillIDs));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != SkillSetCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseSkillSetDialog dlg = new ChooseSkillSetDialog(text.getShell());
        dlg.setSelectedSkill(skillIDs);
        if (dlg.open() == Dialog.OK) {
            skillIDs = dlg.getSelectedSkills();
            text.setText(SkillConfig.toString(EditorApplication.getProj(), skillIDs));
            fireApplyEditorValue();
            deactivate();
        }
