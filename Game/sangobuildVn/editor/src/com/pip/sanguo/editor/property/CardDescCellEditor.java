...
public class CardDescCellEditor extends CellEditor {
    ...
    public CardDescCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                CardDescCellEditor.this.focusLost();
            }
        });
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != CardDescCellEditor.class;
    }
    ...
    protected void editText() {
        CardDescDialog dlg = new CardDescDialog(text.getShell(),text.getText());
        dlg.setText(text.getText());
