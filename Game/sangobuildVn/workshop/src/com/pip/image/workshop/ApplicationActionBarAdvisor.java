...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void makeActions(final IWorkbenchWindow window) {
		...
		sizeAction4 = new Action("480x320") {
			public void run() {
				WorkshopApplication.setScreenSize(480, 320);
			}
		};

		sizeAction5 = new Action("640x360") {
			public void run() {
				WorkshopApplication.setScreenSize(640, 360);
			}
		};

		sizeAction6 = new Action("960x640") {
			public void run() {
				WorkshopApplication.setScreenSize(960, 640);
			}
		};
...
//			window.getActivePage().showView("org.eclipse.swt.sleak.views.SleakView");
	...
	protected void fillMenuBar(IMenuManager menuBar) {
		...
		menuManager.add(new Action("合并多个动画"){
			@Override
			public void run() {
