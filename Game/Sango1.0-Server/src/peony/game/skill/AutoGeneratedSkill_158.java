...
public class AutoGeneratedSkill_158 extends AbstractSkill implements CombatEffect {
    ...
    public AutoGeneratedSkill_158(int lvl) {
        super(158, "拉人过来", lvl);
        if (lvl > 1) {
    ...
    public String getDesc(Unit owner) {
        return "把目标周围20尺范围内的敌人从15尺外拉到自己身边";
    }
