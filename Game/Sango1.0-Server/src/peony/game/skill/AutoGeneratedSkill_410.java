...
public class AutoGeneratedSkill_410 extends AbstractSkill implements CombatEffect {
    ...
    public AutoGeneratedSkill_410(int lvl) {
        super(410, "水boss大治疗", lvl);
        if (lvl > 5) {
