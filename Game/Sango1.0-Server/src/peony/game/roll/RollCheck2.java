...
public class RollCheck2 implements Runnable{
	public void run(){
		...
		System.out.println("ROLLSIZE:"+rolls.size()+"TIME:"+Time.currTime);
		for(Roll r:rolls.values()){
			StringBuilder sb = new StringBuilder();
			sb.append("ROLL[").append(r.id).append("]SIZE[").append(r.infos.length).append("]TIME["+r.startTime+"]");
