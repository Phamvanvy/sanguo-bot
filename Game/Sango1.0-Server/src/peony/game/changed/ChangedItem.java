...
public abstract class ChangedItem {
	...
	public static final int NATION_DUTY = 53; //国家官职
	public static final int TIMEOUT = 54; //包月是否过期
	public static final int SALARY = 55;//取得工资
	public static final int MATESKILL_GROUPID = 56;//遗忘夫妻技能
	public static final int FULIVALUE = 57;//抽奖福利值
	public static final int FRESHENTERMAP = 58;//新手进入地图状态
	public static final int ATTENDANT_LEVEL = 59;//随从合成等级
	public static final int MULCHARGE_DAYS = 60;//累充剩余天数
	public static final int VIP_LEVEL = 61;//VIP等级
	public static final int ACTIVITY_STATE = 62;//新区活动状态
	
	public static final int NAME = 1;
	public static final int CREDIT_STRING = 2;
	public static final int GUILD = 3;
	public static final int TITLE = 4;
	public static final int YUANBAO = 5;	//元宝
	...
	public static final int HORSE_FOOD = 10;//坐骑口粮
	public static final int ENEMY_IN_NUTURAL = 10;//仇人同在中立地图上
	public static final int CARD_EQUIP = 11;
	public static final int REMOVE_SKILL = 12;
	public static final int INVALIDITEM = 13;//过期物品提示
//	public int strength;
//	public int agility;
