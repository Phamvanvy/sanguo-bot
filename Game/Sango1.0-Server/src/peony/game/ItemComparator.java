...
//11	u	普通类：主要定义任务物品。
	...
	public static final int[] SPECIAL_ORDER_FRONT_ITEMS = {1918,1919,1920,1921,1922,1923,1924,1925,1926,1927,1928,2286};
...
//    public static final int TYPE_REFINE = 11;
	...
	public static boolean isFrontOrderItem(int itemId){
		for(int id : SPECIAL_ORDER_FRONT_ITEMS){
			if(id==itemId)
				return true;
		}
		return false;
...
//		boolean o1_isFront = isFrontOrderItem(o1.template.id);
//		boolean o2_isFront = isFrontOrderItem(o2.template.id);
//		if(o1_isFront && o2_isFront)
