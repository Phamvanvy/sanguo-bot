...
public class MemberUserType implements UserType {
	...
	public Object nullSafeGet(ResultSet resultSet, String[] names, Object owner)
		...
		if (bytes == null) {
			...
			return Members.fromDBBytes(bytes);
		}
	}
	...
	public void nullSafeSet(PreparedStatement statement, Object value, int index)
		...
		if (value == null)
			...
			statement.setBytes(index, ((Members) value).toDBBytes());
		}
	}
