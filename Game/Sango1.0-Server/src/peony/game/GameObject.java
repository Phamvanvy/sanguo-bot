...
public abstract class GameObject {
	...
	public static final String[] FACTION_NAME = {peony.Messages.STRING_01795,peony.Messages.STRING_01796,peony.Messages.STRING_01797,peony.Messages.STRING_01798,peony.Messages.STRING_01799,peony.Messages.STRING_01800,peony.Messages.STRING_01801};
...
//		this.move = new Move();
		...
		if (this.x != x || this.y != y) {
			...
			if (v != null) {
				...
				if (type != GameObject.TYPE_PLAYER) {
					...
					MapCell cell = v.getMapCell(x, y);
					if (cell != null) {
						if (cell != mapCell || mapCell!=null && !mapCell.objects.contains(this)) {
	...
	public GameObjectRef ref() {
		if (lastRef == null) {
			lastRef = new GameObjectRef(type,id,getInstanceId());
		}
		return lastRef;
	}
...
//			if(self.type==GameObject.TYPE_PLAYER && other.type==GameObject.TYPE_PLAYER){
//				Player selfPlayer = (Player)self;
//				Player otherPlayer = (Player)other;
//				if(Server.isStepServer && selfPlayer.isInStep && otherPlayer.isInStep)
//					return true;
//			}
	...
	public void removeFromWorld(){
		...
		if(type==TYPE_CREATURE){
			try{((Creature)this).clearThreats();}catch(Exception e){}
		}
	}
