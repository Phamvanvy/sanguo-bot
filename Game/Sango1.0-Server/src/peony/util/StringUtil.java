...
//	}
	...
	public static final void init(File nameFile, File keywordsFile, List<String> strings) throws Exception{
		...
		tongNameValidator = new NameValidator(keywordsManager, 1, 16, false, false);
	...
	public static String getValidatorMessage(int code) {
		...
		case IStringValidator.MAX_LIMIT:
			return peony.Messages.STRING_00945;
		case IStringValidator.MIN_LIMIT:
			return peony.Messages.STRING_00946;
		case IStringValidator.ILLEGAL_CHAR:
			return peony.Messages.STRING_00947;
		case IStringValidator.NULL:
			return peony.Messages.STRING_00948;
		case IStringValidator.ERROR_PATTERN:
			return peony.Messages.STRING_00949;
		default:
			return peony.Messages.STRING_00950;
		}
	}
	
	public static final void main(String[] args) {
//		Pattern p = Pattern.compile("：[a-zA-z]+://[^\\s]*");
		System.out.println(peony.Messages.STRING_00951.replaceAll("(\\w+\\.)+[a-zA-Z]+", "3g.pipgame.cn"));
