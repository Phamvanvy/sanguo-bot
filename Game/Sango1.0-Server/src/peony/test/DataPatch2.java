            ...
            try {
				...
				try {
					...
					for (int i = 0; i < list.size(); i++) {
					    ...
					    String title = MessageFormat.format(peony.Messages.STRING_01841, name);
					    GameItem item = ObjectAccessor.createGameItem(1228);
					    ms.sendSystemMail(id, peony.Messages.STRING_00004, peony.Messages.STRING_01842, title, 0, item, 1, "GM");
					}
				} catch (Exception e) {
					log.error(e,e);
				}
