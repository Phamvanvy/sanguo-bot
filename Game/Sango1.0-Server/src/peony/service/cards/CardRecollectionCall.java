...
//					int qulity = p.pool.getInt(cardService.getPropertyOfCardQuality(cd.id),0);
...
//					}
					...
					if (it == null) {
						...
						tx.commit();
						//ø®∆¨≥‰ƒ‹
//						int cardEnergy = cardService.generateCardEnergy(p, cd);
//						cardService.addCardEnergy(p, cd, cardEnergy, isFlash);
					}
				} else {
