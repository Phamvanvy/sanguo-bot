...
public class NoItemShopBuy extends ShopItemBuy{
    ...
    /** 二十元宝物品id**/
    public static int ERSHIYUANBAO = 3600;
    /** 三十元宝物品id**/
    public static int SANSHISHIYUANBAO = 3700;
    /** 书籍专用六十元宝物品id**/
    public static int LIUSHIYUANBAO = 4128;
    /** 书籍专用一元宝物品id**/
    public static int BOOKYIYUANBAO = 4129;
    /**一百元宝物品id*/
    public static int YIBAIYUANBAO=1277;
	...
	public void receive(PlayerTransaction tx, boolean supportMail)
		...
		if(ibuy!=null){
			log.info("[DEBUG][DECIMONEYEFFECT]HASHCODE["+ibuy.hashCode()+"]RECEIVE");
			ibuy.process(obj);
		}
		log.info("[DEBUG][DECIMONEYEFFECT]HASHCODE[NULL]"+"RECEIVE");
	}
