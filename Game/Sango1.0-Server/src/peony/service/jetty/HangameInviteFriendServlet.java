        ...
        if(p == null){
            ...
            if("0".equals(type)){
                ...
                if(itemCount > 0){
                    try{
                        ...
                        Server.server.getServiceRegistry().getMailService()
                                        .sendSystemMail(p.id, peony.Messages.STRING_00004, peony.Messages.STRING_00022, MessageFormat.format(peony.Messages.STRING_00023, inviteCount), 0, item, itemCount, "HANGAME");
                    }catch(Exception e){
                        log.error(e, e);
                    }
                }
                ...
                try{
                    ...
                    Server.server.getServiceRegistry().getMailService().sendSystemMail(p.id, peony.Messages.STRING_00004, peony.Messages.STRING_00022, peony.Messages.STRING_00024, 0, item, 10, "HANGAME");
                }catch(Exception e){
                    log.error(e, e);
                }
