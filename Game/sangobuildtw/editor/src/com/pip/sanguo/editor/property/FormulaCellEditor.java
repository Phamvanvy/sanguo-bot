 ...
 * ≈‰∑Ω—°‘Ò°£
 */
public class FormulaCellEditor extends CellEditor {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                FormulaCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        formulaID = ((Integer)value).intValue();
        text.setText(Formula.toString(EditorApplication.getProj(), formulaID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != FormulaCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseFormulaDialog dlg = new ChooseFormulaDialog(text.getShell());
        dlg.setSelectedFormula(formulaID);
        if (dlg.open() == Dialog.OK) {
            formulaID = dlg.getSelectedFormula();
            text.setText(Formula.toString(EditorApplication.getProj(), formulaID));
            fireApplyEditorValue();
            deactivate();
        }
