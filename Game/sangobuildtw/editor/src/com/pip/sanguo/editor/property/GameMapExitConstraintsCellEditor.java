 ...
 * 出口限制编辑器。
 */
public class GameMapExitConstraintsCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected GameMapExitConstraints constraints;

    public GameMapExitConstraintsCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                GameMapExitConstraintsCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        Assert.isTrue(text != null && (value instanceof GameMapExitConstraints));
        constraints = ((GameMapExitConstraints)value).dup();
        text.setText(constraints.toString());
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != GameMapExitConstraintsCellEditor.class;
    }
    ...
    protected void editText() {
        EditGameMapExitConstraintsDialog dlg = new EditGameMapExitConstraintsDialog(text.getShell());
        dlg.setEditObject(constraints.dup());
        if (dlg.open() == Dialog.OK) {
            constraints = dlg.getEditObject().dup();
            text.setText(constraints.toString());
            fireApplyEditorValue();
            deactivate();
        }
