 ...
 * NPC±à¼­Æ÷¡£
 */
public class NPCCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int npcID;

    public NPCCellEditor(Composite parent) {
    ...
    protected void doSetValue(Object value) {
        ...
        npcID = ((Integer)value).intValue();
        text.setText(GameMapObject.toString(EditorApplication.getProj(), npcID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != NPCCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseNPCDialog dlg = new ChooseNPCDialog(text.getShell());
        dlg.setSelectedNPC(npcID);
        if (dlg.open() == Dialog.OK) {
            npcID = dlg.getSelectedNPC();
            text.setText(GameMapObject.toString(EditorApplication.getProj(), npcID));
            fireApplyEditorValue();
            deactivate();
        }
