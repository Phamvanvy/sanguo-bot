 ...
 * »ŒŒÒ—°‘Ò°£
 */
public class QuestCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int questID;

    public QuestCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                QuestCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        questID = ((Integer)value).intValue();
        text.setText(Quest.toString(EditorApplication.getProj(), questID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != QuestCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseQuestDialog dlg = new ChooseQuestDialog(text.getShell());
