...
public class PipAnimateSet{
    ...
    private void load(DataInputStream dis) throws IOException{
        ...
        //#if DoubleScreen == true
        //# Object[] tmpArr = readIntArray(dis, framePos, frameLen, version);
        ...
        //#if DoubleScreen == true
        //# tmpArr = readIntArray(dis, animatePos, animateLen, (byte)0);
    ...
    //#if DoubleScreen == true
  //# private Object[] readIntArray(DataInputStream dis, short[] start, byte[] len, byte ver) throws IOException {
