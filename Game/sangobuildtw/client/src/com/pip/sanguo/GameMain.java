...
//            }
    ...
    public static String getChannelCode(){
        //#ifdef buildtest
        return "CCCCCPiP";
        //#elif ModelID == Lenovo || ModelID == AndroidLarge || ModelID == Android || ModelID == AndroidSmall
    ...
    public void paint(Graphics g){
        ...
        try{
            ...
            //#elif ModelID == Lenovo || ModelID == AndroidLarge || ModelID == Android
            //# forcePaintWorld = VMGame.isAllTransparent(false);
            //#else
            ...
            //#if ModelID == Lenovo || ModelID == AndroidLarge || ModelID == Android	 
            //#  if(battleRemind[5] == 0)
            //#  {
    ...
    public void cycle(){
        try{
            ...
            //检测屏幕大小变化
            //#if ScreenCanReset == true && ModelID != Lenovo && ModelID != AndroidLarge && ModelID != Android && ModelID != AndroidSmall
