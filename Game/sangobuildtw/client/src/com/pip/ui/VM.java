...
public class VM implements CommandListener{
    ...
    public int getRealizeAdrr(int objAdrr) {
    	int ret = 0;
    	try {
			ret = syscall((short)0x0010, new int[]{objAdrr});
		} catch (Exception e) {
			//#ifdef buildtest
			e.printStackTrace();
			//#endif
    ...
    int syscall2(short funcID, int[] params) throws Exception{
    	switch(funcID){
            ...
            case 0x0031: // 0x0031=Object AnimateSet_Create(ImageSet[] imgs, String ctnFile)
            {
                ...
                return makeTempObject(new PipAnimateSet(imgs, GameMain.resourceManager.findResource(ctnFile)));
            }
            ...
            case 0x0036: //0x0034=Object AnimateSet_GetAnimateBox(Object set, int index) 
                return makeTempObject(((PipAnimateSet)followPointer(params[0])).getAnimateBox(params[1]));
            case 0x0041: // 0x0041=ImageSet ImageSet_Create(String fileName)
                try {
                    return makeTempObject(new ImageSet((String)followPointer(params[0])));
                } catch (Exception e) {
                	//#ifdef buildtest
                    e.printStackTrace();
                  //#endif
            ...
            case 0x0044: // 0x0044=ImageSet ImageSet_Create4(byte[] imgData)
                try {
                    return makeTempObject(new ImageSet((byte[])followPointer(params[0])));
                } catch (Exception e) {
                	//#ifdef buildtest
                    e.printStackTrace();
                  //#endif
            ...
            case 0x1265: //0x1265=boolean GIsNeedScrollBar(GContainer gContainer)
            	return ((GContainer)getGW(params[0])).needScrollBar ? TRUE : FALSE;
            ...
            case 0x127C: //0x127C=Object GetGWinVMGame(GWindow gWindow)
            	return this.makeTempObject(((GWindow)getGW(params[0])).getVMGame());
            case 0x127D: //0x127D=void GSendEvent(VMGame vmGame, GWidget gWidget, int _eventType, int _param0, int[] _param2, Object _param1, Object[] _param3)
    			...
    			if(_gWidget != null && _gWidget.vmData[GWidget.GW_VM_FUNC_SEND_EVENT] > 0) {
    				synchronized (gtvm) {
        				gtvm.callback(_gWidget.vmData[GWidget.GW_VM_FUNC_SEND_EVENT], new int[] { 
...
//                break;
            ...
            case 0x3004: //0x3004=void UpdateFile(String name)
                Tool.sendGetFile((String)followPointer(params[0]));
                break;
...
//                return VMWidget.drawAttrNum((String)followPointer(params[1]), (Graphics)followPointer(params[0]), params[2], params[3], Graphics.TOP | Graphics.LEFT);
            ...
            case 0x5717: //0x5717=Object GGetScrollBar(GContainer gContainer)
            	GScrollBar sb = ((GContainer)this.getGW(params[0])).getScrollBar();
            	if(sb != null) {
            ...
            case 0x571A: //0x571A=int[] GGetIntersect(GWidget gWidget)
            {
            	GWidget gWidget = this.getGW(params[0]);
            	if(gWidget != null) {
            		return this.makeTempObject(gWidget.getIntersect());
            	} else {
            		return 0;
            	}
            }
          ...
          //api版本2.0 begin
            ...
            //#if ModelID == Lenovo || ModelID == AndroidLarge || ModelID == Android || ModelID == AndroidSmall
            ...
            //#if Revision == TAIWAN
				case 0x5765:{//0x5765=Object Handler_Create()
					...
					//#  	SanguoMIDlet.igbKernel = new billing.IGBKernel(SanguoMIDlet.DEFAULT_ACTIVITY);
            ...
            case 0x6500: //0x6500=void ConfirmExit()
            {
            	if(!(GameMain.display.getCurrent() instanceof Alert)){
            		synchronized(this) {            			
    	                ...
    	                alert.addCommand(new Command("确认", Command.OK, 0));
    	                alert.addCommand(new Command("取消", Command.CANCEL, 0));
    	                GameMain.display.setCurrent(alert);    	                
//    	                this.pauseProcess();
    				}
            	}
    ...
    public void commandAction(Command cmd, Displayable d){
		//#if ModelID == Lenovo || ModelID == AndroidLarge || ModelID == Android || ModelID == AndroidSmall
		VMGame mainmenu;
		if (isExit && "确认".equals(cmd.getLabel())) {
			// this.resume();
