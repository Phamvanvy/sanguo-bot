...
public class UWAPData {
    ...
    public UWAPData(byte[] data, int serial, int sessionId,
        ...
        if(this.version == 1)
        	...
        	appType = (short)getNumber(data,0,version);
        this.sessionId = sessionId;
        this.numOfParameter = this.data[4+version];
        this.serial = serial;
        pos = 5 + version;
    ...
    public String toString() {
        ...
        for (int i = 0; i < numOfParameter; i++) {
            try {
                switch (data[pos]) {
                    case 1: //	布尔类型。
                        sbuf.append(sep).append("boolean:").append(
                                readBoolean());
                        break;
                    case 2: //	单字节有符号整数
...
//					break;
                    ...
                    case 7: //	UTF-8字符串
                        ...
                        break;
                    case 8: //	UTF-16字符串
                        sbuf.append(sep).append("UTF-16:")
                                .append(this.readString());
                        break;
                    case 17: {
                    ...
                    case 18: {
                        byte[] barr = readBytes();
                        sbuf.append(sep).append("byte array num:").append(
                                barr.length).append(" data:");
                        if (barr.length < 40) {
                            for (int j = 0; j < barr.length; j++) {
                                sbuf.append(" ").append(barr[j]);
...
//					break;
                    case 20: {
                        int[] barr = readInts();
                        sbuf.append(sep).append("int array num:").append(
                                barr.length).append(" data:");
                        for (int j = 0; j < barr.length; j++) {
                            sbuf.append(" ").append(barr[j]);
                        }
                    ...
                    case 21: {
                        long[] barr = readLongs();
                        sbuf.append(sep).append("long array num:").append(
                                barr.length).append(" data:");
                        for (int j = 0; j < barr.length; j++) {
                            sbuf.append(" ").append(barr[j]);
                        }
                    ...
                    case 22: {
                        ...
                        sbuf.append(sep).append("short array num:").append(
                                barr.length).append(" data:");
                        for (int j = 0; j < barr.length; j++) {
                            sbuf.append(" ").append(barr[j]);
                        }
                ...
                sbuf.append(sep).append("参数错误num:").append(i).append(" type:")
                        .append(data[pos]);
                break;
