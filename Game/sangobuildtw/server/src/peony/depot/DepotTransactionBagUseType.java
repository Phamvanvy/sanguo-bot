...
public class DepotTransactionBagUseType implements UserType {
	...
	public Object nullSafeGet(ResultSet resultSet, String[] names, Object owner)
		...
		if (bytes == null){
			...
			return new TransactionBag(player,0,0);
		}
		else {
			return ItemUtil.getTransactionBagFromDB(bytes, (Player) owner);
		}
	}
