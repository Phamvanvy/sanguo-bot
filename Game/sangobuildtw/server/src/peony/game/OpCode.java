...
//	public static final short EXCHANGE_GRIDFULL_SERVER = 363;
	 ...
	 * playerinstanceid		int				玩家实例ID	-1为自己
	 */
	 ...
	 * count					    int				密信的个数
	 */
	public static final short HANDIN_LETTER_CLIENT = 952;
	
	/**
	 * 玩家提交密信返回
	 * serial						int
	 */
	public static final short HANDIN_LETTER_SERVER = 953;
