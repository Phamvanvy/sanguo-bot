...
public class CellMapEditorActionBarContributor extends EditorActionBarContributor implements IPartListener, IPropertyListener, IPropertyChangeListener {
    private CellMapEditor activeEditor;
    ...
    public void partActivated(IWorkbenchPart part) {
        if (part instanceof CellMapEditor) {
            activeEditor = (CellMapEditor)part;
    ...
    public void propertyChanged(Object source, int propId) {
        if (source == activeEditor) {
            if (propId == CellMapEditor.PROPERTY_CANUNDO) {
                undoAction.setEnabled(activeEditor.canUndo());
            } else if (propId == CellMapEditor.PROPERTY_CANREDO) {
                redoAction.setEnabled(activeEditor.canRedo());
            }
        }
    }
