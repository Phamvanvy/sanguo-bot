...
public class EquipAnimateViewer extends AnimateViewer {
	...
	protected void drawInformation(GC gc) {
		...
		gc.setForeground(SWTResourceManager.getColor(0));
//		if(equipCtsModified){// || true){
//			if(fontSize == null){
//				fontSize = gc.stringExtent("字");
//			}
//			int h = fontSize.x+5;
//			gc.drawString("装备动画基准点已改变", 10, h*2);
//			gc.drawString("保存", 10, h*3);
//			saveButtonRect = new Rectangle(8, h*3-2, fontSize.x*2+4, fontSize.y+4);
//			gc.drawRectangle(saveButtonRect);
//		}
	}
