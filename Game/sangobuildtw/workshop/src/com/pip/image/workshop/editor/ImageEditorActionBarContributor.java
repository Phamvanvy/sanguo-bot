...
public class ImageEditorActionBarContributor extends EditorActionBarContributor implements IPartListener, IPropertyListener, IPropertyChangeListener {
	private ImageEditor activeEditor;
	...
	public void partActivated(IWorkbenchPart part) {
		if (part instanceof ImageEditor) {
			activeEditor = (ImageEditor)part;
