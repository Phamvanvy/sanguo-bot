...
public class UseIMoneyCardMessage extends AbstractMessage {
	...
	public UseIMoneyCardMessage(int serial, String gameCode, int accountID, String key, String cardno, String password, int amount) {
		super(GameAccountMessageType.USE_IMONEY_CARD, serial);
		this.gameCode = gameCode;
		this.accountID = accountID;
		this.key = key;
	...
	public UseIMoneyCardMessage(String gameCode, int accountID, String key, String cardno, String password, int amount) {
		super(GameAccountMessageType.USE_IMONEY_CARD);
		this.gameCode = gameCode;
		this.accountID = accountID;
		this.key = key;
