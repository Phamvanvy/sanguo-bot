...
public class MessageEncoder implements IMessageEncoder {
	...
	public UWAPSegment encode(IMessage message) throws Exception {
		...
		case GameAccountMessageType.BIND_ACCOUNT:
			return getBindAccountSeg((BindAccountMessage)message);
        case GameAccountMessageType.GET_BACK_ACCOUNT:
        	return getGetBackAccountSeg((GetBackAccountMessage)message);
        case GameAccountMessageType.GET_BACK_ACCOUNT_OK:
        	return getGetBackAccountOkSeg((GetBackAccountOkMessage)message);
		default:{
	...
	protected UWAPSegment getGetBackAccountOkSeg(GetBackAccountOkMessage message) {
        UWAPSegment seg = new UWAPSegment(message.getCmd(), message.getSerial());
        seg.writeInt(message.getAccountID());
        seg.writeString(message.getAccountName());
        seg.writeString(message.getPassword());
        seg.writeString(message.getPartition());
        return seg;
	}
	
	protected UWAPSegment getGetBackAccountSeg(GetBackAccountMessage message) {
        UWAPSegment seg = new UWAPSegment(message.getCmd(), message.getSerial());
        seg.writeInt(message.getGameCode());
        seg.writeString(message.getClientID());
        return seg;
	}
	
	protected UWAPSegment getBindAccountSeg(BindAccountMessage message) {
        UWAPSegment seg = new UWAPSegment(message.getCmd(), message.getSerial());
        seg.writeInt(message.getAccountID());
        seg.writeInt(message.getGameCode());
        seg.writeString(message.getClientID());
    ...
    protected UWAPSegment getUseIMoneyCardOkSeg(UseIMoneyCardOkMessage message) {
		...
		seg.writeLong(message.getLongBalance());
		seg.writeLong(message.getBBalance());
		return seg;
	}
	...
	protected UWAPSegment getLegacyBuy1Seg(LegacyBuy1Message message){
		...
		seg.writeString(message.getKey());
		seg.writeInt(message.getValue());
		seg.writeBoolean(message.isTrustOnly());
		return seg;
	}
