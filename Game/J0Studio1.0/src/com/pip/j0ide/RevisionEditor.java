...
public class RevisionEditor extends EditorPart {

	private Composite composite;
	private Table table;
	public static final String ID = "com.pip.j0ide.RevisionEditor"; //$NON-NLS-1$
	private RevisionInput varInput;
	...
	public void createPartControl(Composite parent) {
		...
		for (int i = 0; i < varInput.project.targets.size(); i++) {
			variables.add((Variable)varInput.project.targets.get(i).clone());
		}
    ...
    public void doSave(IProgressMonitor monitor) {
        varInput.project.targets.clear();
        for (int i = 0; i < variables.size(); i++) {
            varInput.project.targets.add((Variable)variables.get(i).clone());
        }
