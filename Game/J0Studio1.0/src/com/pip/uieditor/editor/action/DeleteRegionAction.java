...
public class DeleteRegionAction extends Action implements ISelectionChangedListener {
	
	public static final String ID = "com.pip.uieditor.editor.action.deleteregion";
	
	private EditPartViewer viewer;
	
	public DeleteRegionAction(EditPartViewer viewer) {
		this.viewer = viewer;
		initUI();
	...
	protected void initUI() {
		setId(ID);
		setText("Delete Region");
		setToolTipText("Delete Region");
		setEnabled(false);
	}
