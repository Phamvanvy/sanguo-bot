...
public class RichTextCellEditor extends CellEditor {
    ...
    protected Object doGetValue() {
        return RichTextParser.parseEscapedString(text.getText());
    }
    ...
    protected void doSetValue(Object value) {
        ...
        content = RichTextParser.escapeString(content);
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != RichTextCellEditor.class;
    }
    ...
    protected void editText() {
        RichTextDialog dlg = new RichTextDialog(text.getShell());
        dlg.setText(RichTextParser.parseEscapedString(text.getText()));
        if (dlg.open() == Dialog.OK) {
            text.setText(RichTextParser.escapeString(dlg.getText()));
            fireApplyEditorValue();
            deactivate();
        }
    }
