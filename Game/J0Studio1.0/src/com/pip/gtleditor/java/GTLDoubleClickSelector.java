 ...
 */
public class GTLDoubleClickSelector implements ITextDoubleClickStrategy {
	 ...
	 protected boolean matchBracketsAt() {
		...
		try {
			...
			if (fStartPos > -1 && bracketIndex1 < bracketIndex2) {
				...
				fStartPos= searchForOpenBracket(fEndPos, fgBrackets[bracketIndex2 - 1], prevChar, doc);
				if (fStartPos > -1)
					return true;
				fEndPos= -1;
			}
