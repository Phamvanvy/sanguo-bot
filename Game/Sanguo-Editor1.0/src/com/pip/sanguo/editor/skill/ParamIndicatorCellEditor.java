 ...
 * ²ÎÊýÐÞ¸ÄÆ÷±à¼­¡£
 */
public class ParamIndicatorCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected ParamIndicator editObj = new ParamIndicator();

    public ParamIndicatorCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                ParamIndicatorCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        editObj.load((String)value);
        text.setText(editObj.toString(EditorApplication.getProj()));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != ParamIndicatorCellEditor.class;
    }
    ...
    protected void editText() {
        EditParamIndicatorDialog dlg = new EditParamIndicatorDialog(text.getShell());
        dlg.setEditObject(editObj);
        if (dlg.open() == Dialog.OK) {
            editObj.update(dlg.getEditObject());
            text.setText(editObj.toString(EditorApplication.getProj()));
            fireApplyEditorValue();
            deactivate();
        }
