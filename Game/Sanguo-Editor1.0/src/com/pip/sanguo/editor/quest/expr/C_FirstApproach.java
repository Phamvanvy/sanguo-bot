...
public class C_FirstApproach extends AbstractExpr {
    ...
    public String getExpression() {
        return "E_FirstApproach(" + mapID + ", " + x + ", " + y + ")";
    }
    ...
    public String toNatureString() {
        String targetName = GameMapInfo.locationToString(EditorApplication.getProj(), new int[] { mapID, x, y }, false);
        return "玩家第一次接近 " + targetName;
    }
    ...
    public IExpr recognize(QuestInfo qinfo, Expression expr) {
        if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("E_FirstApproach") && expr.getRightExpr() == null) {
            ...
            if (param1.getRightExpr() == null && param1.getLeftExpr().type == Expr0.TYPE_NUMBER &&
                ...
                C_FirstApproach ret = (C_FirstApproach)createNew(qinfo);
