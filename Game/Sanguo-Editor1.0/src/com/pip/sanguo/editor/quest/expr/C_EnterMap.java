...
import com.pip.sanguo.editor.property.ScenePropertyDescriptor;
...
public class C_EnterMap extends AbstractExpr {
	...
	public String toNatureString() {
	    return "玩家进入场景 " + GameMapInfo.toString(EditorApplication.getProj(), sceneID);
	}
    ...
    public IPropertyDescriptor[] getPropertyDescriptors() {
        return new IPropertyDescriptor[] { 
                new ScenePropertyDescriptor("sceneID", "目标场景")
        };
    }
