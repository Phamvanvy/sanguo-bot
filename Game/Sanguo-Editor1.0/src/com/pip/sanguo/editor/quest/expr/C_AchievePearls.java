...
public class C_AchievePearls extends AbstractExpr{
    /**
     * 表达式模板：检测玩家达成连珠。
     */
     ...
     * @param name 全局变量名称
     */
    public C_AchievePearls(QuestInfo qinfo) {
        templateID = 0;
    ...
    public String getExpression() {
        return "E_ReachPearls(" + templateID + ", \"" + PQEUtils.reverseConv(varName) + "\", " + max + ")";
    }
    ...
    public IExpr createNew(QuestInfo qinfo) {
        return new C_AchievePearls(qinfo);
    }
    ...
    public IExpr recognize(QuestInfo qinfo, Expression expr) {
        if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("E_ReachPearls") && expr.getRightExpr() == null) {
            ...
            if (param1.getRightExpr() == null && param1.getLeftExpr().type == Expr0.TYPE_NUMBER &&
                ...
                C_AchievePearls ret = (C_AchievePearls)createNew(qinfo);
    ...
    public IPropertyDescriptor[] getPropertyDescriptors() {
        return new IPropertyDescriptor[] { 
                new NPCTemplatePropertyDescriptor("templateID", "棋子"),
