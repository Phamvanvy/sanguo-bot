...
public class C_KillWithAssociation extends AbstractExpr {
     ...
     * @param name 全局变量名称
     */
    public C_KillWithAssociation(QuestInfo qinfo) {
        templateID = 0;
    ...
    public String getExpression() {
        return "E_KillWithAssociation(" + templateID + ", \"" + PQEUtils.reverseConv(varName) + "\", " + max + ")";
    }
    ...
    public IExpr createNew(QuestInfo qinfo) {
        return new C_KillWithAssociation(qinfo);
    }
    ...
    public IExpr recognize(QuestInfo qinfo, Expression expr) {
        if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("E_KillWithAssociation") && expr.getRightExpr() == null) {
            ...
            if (param1.getRightExpr() == null && param1.getLeftExpr().type == Expr0.TYPE_NUMBER &&
                ...
                C_KillWithAssociation ret = (C_KillWithAssociation)createNew(qinfo);
