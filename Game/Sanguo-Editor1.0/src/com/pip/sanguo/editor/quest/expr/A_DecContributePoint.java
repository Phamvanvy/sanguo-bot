 ...
 * 表达式模板：扣除贡献度。
 */
public class A_DecContributePoint extends AbstractExpr {
    public int value;
    ...
    public IExpr createNew(QuestInfo qinfo) {
        return new A_DecContributePoint();
    }
    ...
    public String getExpression() {
        return "DecContributePoint(" + value+ ")";
    }
    ...
    public IExpr recognize(QuestInfo qinfo, Expression expr) {
        if (expr.getLeftExpr().type == Expr0.TYPE_FUNC && expr.getLeftExpr().getFunctionCall().funcName.equals("DecContributePoint") && expr.getRightExpr() == null) {
            ...
            if (param1.getRightExpr() == null && param1.getLeftExpr().type == Expr0.TYPE_NUMBER) {
                A_DecContributePoint ret = (A_DecContributePoint)createNew(qinfo);
