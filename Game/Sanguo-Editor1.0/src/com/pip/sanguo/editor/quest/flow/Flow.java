...
import com.pip.sanguo.editor.quest.QuestFlowViewer;
import com.pip.sanguo.editor.quest.expr.A_Chat;
import com.pip.sanguo.editor.quest.expr.A_Message;
...
public class Flow {
     ...
     * @return 流程对象的数组。
     */
    public static List<Flow> parseQuest(QuestInfo questInfo, boolean flatMode) {
     ...
     */
    public static Flow recognize(QuestInfo questInfo, boolean flatMode, List<Flow> flows) {
