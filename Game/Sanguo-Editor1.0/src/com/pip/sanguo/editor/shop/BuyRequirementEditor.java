...
public class BuyRequirementEditor extends Composite {
    ...
    private static final int[] TYPE_MAPPING = { Shop.TYPE_RANK, Shop.TYPE_ITEM, Shop.TYPE_HONOR, Shop.TYPE_MONEY, 
        Shop.TYPE_IMONEY, Shop.TYPE_VARIABLE, Shop.TYPE_LEVEL, Shop.TYPE_CONSUMECODE, Shop.TYPE_EXP, 
        Shop.TYPE_SALARY, Shop.TYPE_REPUTATION };
