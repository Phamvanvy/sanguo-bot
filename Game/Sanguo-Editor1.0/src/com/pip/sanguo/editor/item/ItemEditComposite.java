...
public class ItemEditComposite extends Composite  implements ISelectionChangedListener,SelectionListener{
    ...
    private Combo comboExtraItemType;
    ...
    public static final String[] COMBO_TYPES = { "普通物品", "技能书", "坐骑", "坐骑口粮", "称号", "材料", "打造配方", "宝石", "补给", "杂物", "精炼" ,"卡片", "法宝", "随从","坐骑礼包","随从技能书","书籍"};
    public static final int[] TYPE_MAP = { Item.TYPE_NORMAL, Item.TYPE_SKILLBOOK, Item.TYPE_HORSE, 
                                           ...
                                           Item.TYPE_TALISMAN, Item.TYPE_ATTENDANT,Item.TYPE_HORSE_PACKAGE,
                                           Item.TYPE_ATTENDANT_SKILL,Item.TYPE_BOOK};
    
    public static final String[] COMBO_TYPES2 = { "无", "装备物品", "宝石物品"};
    public static final int[] TYPE_MAP2 = { Item.TYPE_NORMAL, Item.TYPE_ITEM_EQUIP, Item.TYPE_ITEM_JEWEL};
    ...
    public ItemEditComposite(Composite parent, int style, DefaultDataObjectEditor handle) {
        ...
        comboItemType.setItems( COMBO_TYPES );
        comboItemType.addSelectionListener(this);
        
        final Label label_29 = new Label(this, SWT.NONE);
        label_29.setText("物品类型2：");

        comboExtraItemType = new Combo(this, SWT.READ_ONLY);
        comboExtraItemType.setVisibleItemCount(15);
        final GridData gd_comboExtraItemType = new GridData(SWT.FILL, SWT.CENTER, true, false);
        comboExtraItemType.setLayoutData(gd_comboExtraItemType);
        comboExtraItemType.setItems( COMBO_TYPES2 );
        comboExtraItemType.addSelectionListener(this);
        ...
        textCity.addModifyListener(eventHandle);
...
//        new Label(this, SWT.NONE);
    ...
    public void saveItemData(Item itemDataDef) throws Exception{
        ...
        itemDataDef.extraType = TYPE_MAP2[comboExtraItemType.getSelectionIndex()];
        ...
        itemDataDef.iconImage = iconChooser.getIconImage();
        ...
        itemDataDef.produceArea = textCity.getText().trim();
    }
    ...
    private void setItemData(){
        ...
        for (int i = 0; i < TYPE_MAP2.length; i++) {
            if (editObject.extraType == TYPE_MAP2[i]) {
                comboExtraItemType.select(i);
            }
        }
        ...
        iconChooser.setIcon(editObject.iconIndex, editObject.iconImage);
        if(editObject.sale){
        ...
        textCity.setText(editObject.produceArea);
