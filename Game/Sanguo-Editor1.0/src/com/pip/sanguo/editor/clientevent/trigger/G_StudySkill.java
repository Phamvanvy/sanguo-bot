 ...
 * @author ZHANGBAIQUAN
 */
public class G_StudySkill extends AbstractExprEvent {
    private Text  textParams;    //条件参数
    
    //private static final String[] PARAMS_NAMES = {"技能ID"};
     ...
     * @param name 全局变量名称
     */
    public G_StudySkill(ClientEvent event) {
        clientEvent = event;
    }
