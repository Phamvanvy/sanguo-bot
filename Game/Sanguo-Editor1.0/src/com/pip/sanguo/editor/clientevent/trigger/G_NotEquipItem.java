 ...
 * @author ZHANGBAIQUAN
 */
public class G_NotEquipItem extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public G_NotEquipItem(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public IExprEvent createNew(ClientEvent event) {
        return new G_NotEquipItem(event);
    }
