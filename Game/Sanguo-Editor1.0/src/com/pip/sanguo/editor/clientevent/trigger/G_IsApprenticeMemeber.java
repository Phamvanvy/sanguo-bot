...
public class G_IsApprenticeMemeber extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public G_IsApprenticeMemeber(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public IExprEvent createNew(ClientEvent event) {
        return new G_IsApprenticeMemeber(event);
    }
