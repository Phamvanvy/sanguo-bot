...
public class G_NationDeclarBattleOpen extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public G_NationDeclarBattleOpen(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public IExprEvent createNew(ClientEvent event) {
        return new G_NationDeclarBattleOpen(event);
    }
    ...
    public String getExpression() {
        return "g_nationDeclarBattleOpen";
    }
