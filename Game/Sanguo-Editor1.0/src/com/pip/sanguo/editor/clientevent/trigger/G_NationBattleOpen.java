...
public class G_NationBattleOpen extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public G_NationBattleOpen(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public IExprEvent createNew(ClientEvent event) {
        return new G_NationBattleOpen(event);
    }
