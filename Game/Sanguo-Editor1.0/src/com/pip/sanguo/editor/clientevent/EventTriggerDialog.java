 ...
 *
 */
public class EventTriggerDialog  extends Dialog {
    Composite container;
    ...
    private int type;
    public static int TYPE_CLIENT_GUID = 0;
     ...
     * @param parentShell
     */
    public EventTriggerDialog(Shell parentShell, EventTrigger trigger, int type) {
        super(parentShell);
            ...
            public void widgetSelected(final SelectionEvent e) {
                if(trigger.type != comboTaskFlag.getSelectionIndex()){
                    ...
                    if(type==TYPE_CLIENT_GUID)
                        ...
                        trigger.exprEvent = TempManagerEvent.getExprEvent1(trigger.type);
                    repaintDialog();
                }
            }
        });
