 ...
 * @author ZHANGBAIQUAN
 */
public class G_GetItem extends AbstractExprEvent {
    private Text  textParams;    //条件参数
    
    //private static final String[] PARAMS_NAMES = {"物品ID"};
     ...
     * @param name 全局变量名称
     */
    public G_GetItem(ClientEvent event) {
        clientEvent = event;
    }
