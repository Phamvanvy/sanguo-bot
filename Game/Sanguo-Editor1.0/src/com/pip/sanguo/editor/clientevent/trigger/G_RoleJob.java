 ...
 * @author ZHANGBAIQUAN
 */
public class G_RoleJob extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public G_RoleJob(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public void setParamsValue(){
       params[PARAM_VALUE][0] = String.valueOf(comboJob.getSelectionIndex());
    }
    ...
    public void setPropertyValue(String str) {
        comboJob.select(Integer.parseInt(str));
    }
}
