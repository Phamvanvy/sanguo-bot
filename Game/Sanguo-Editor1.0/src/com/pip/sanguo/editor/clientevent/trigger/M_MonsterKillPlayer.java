 ...
 * @author ZHANGBAIQUAN
 */
public class M_MonsterKillPlayer extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public M_MonsterKillPlayer(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public IExprEvent createNew(ClientEvent event) {
        return new M_MonsterKillPlayer(event);
    }
