 ...
 * @author ZHANGBAIQUAN
 */
public class G_SubmitFinisnQuest extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public G_SubmitFinisnQuest(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public IExprEvent createNew(ClientEvent event) {
        return new G_SubmitFinisnQuest(event);
    }
