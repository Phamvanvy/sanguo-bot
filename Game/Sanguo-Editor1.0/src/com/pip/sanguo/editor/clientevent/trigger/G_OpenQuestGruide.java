 ...
 * @author ZHANGBAIQUAN
 */
public class G_OpenQuestGruide extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public G_OpenQuestGruide(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public IExprEvent createNew(ClientEvent event) {
        return new G_OpenQuestGruide(event);
    }
