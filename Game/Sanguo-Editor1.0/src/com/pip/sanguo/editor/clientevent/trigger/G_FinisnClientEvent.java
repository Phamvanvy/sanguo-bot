 ...
 * @author ZHANGBAIQUAN
 */
public class G_FinisnClientEvent extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public G_FinisnClientEvent(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public IExprEvent createNew(ClientEvent event) {
        return new G_FinisnClientEvent(event);
    }
