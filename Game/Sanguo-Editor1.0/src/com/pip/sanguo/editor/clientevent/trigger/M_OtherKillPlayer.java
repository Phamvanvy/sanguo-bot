 ...
 * @author ZHANGBAIQUAN
 */
public class M_OtherKillPlayer extends AbstractExprEvent {
     ...
     * @param name 全局变量名称
     */
    public M_OtherKillPlayer(ClientEvent event) {
        clientEvent = event;
    }
    ...
    public IExprEvent createNew(ClientEvent event) {
        return new M_OtherKillPlayer(event);
    }
