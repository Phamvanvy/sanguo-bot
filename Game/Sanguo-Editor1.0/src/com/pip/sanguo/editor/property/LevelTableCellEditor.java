 ...
 * ¼¶±ðÓ³Éä±í±à¼­Æ÷¡£
 */
public class LevelTableCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected String mapText = "";

    public LevelTableCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                LevelTableCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        mapText = (String)value;
        text.setText(mapText);
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != LevelTableCellEditor.class;
    }
    ...
    protected void editText() {
        try {
        LevelTableDialog dlg = new LevelTableDialog(text.getShell());
        dlg.setMapString(mapText);
        if (dlg.open() == Dialog.OK) {
            mapText = dlg.getMapString();
            text.setText(mapText);
            fireApplyEditorValue();
            deactivate();
        }
