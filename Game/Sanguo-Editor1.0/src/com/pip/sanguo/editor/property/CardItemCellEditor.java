...
public class CardItemCellEditor extends CellEditor {
    ...
    public CardItemCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                CardItemCellEditor.this.focusLost();
            }
        });
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != CardItemCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseItemByTypeDialog dlg = new ChooseItemByTypeDialog(text.getShell(),Item.TYPE_CARD);
