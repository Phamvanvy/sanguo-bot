...
public class NPCTemplateCellEditor extends CellEditor {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addMouseListener(new MouseAdapter() {
            public void mouseDoubleClick(MouseEvent e) {
                if (e.button == 1) {
                    NPCTemplate template = (NPCTemplate)EditorApplication.getProj().findObject(NPCTemplate.class, templateID);
                    if (template != null) {
    ...
    protected void doSetValue(Object value) {
        ...
        text.setText(NPCTemplate.toString(EditorApplication.getProj(), templateID));
    }
    ...
    protected void editText() {
        ChooseNPCTemplateDialog dlg = new ChooseNPCTemplateDialog(text.getShell());
