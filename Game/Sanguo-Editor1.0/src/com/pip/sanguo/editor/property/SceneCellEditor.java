 ...
 * ³¡¾°±à¼­Æ÷¡£
 */
public class SceneCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int sceneID;

    public SceneCellEditor(Composite parent) {
    ...
    protected Control createControl(Composite parent) {
        ...
        text.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent e) {
                SceneCellEditor.this.focusLost();
            }
        });
    ...
    protected void doSetValue(Object value) {
        ...
        sceneID = ((Integer)value).intValue();
        text.setText(GameMapInfo.toString(EditorApplication.getProj(), sceneID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != SceneCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseSceneDialog dlg = new ChooseSceneDialog(text.getShell());
        dlg.setSelectedMap(sceneID);
        if (dlg.open() == Dialog.OK) {
            sceneID = dlg.getSelectedMap();
            text.setText(GameMapInfo.toString(EditorApplication.getProj(), sceneID));
            fireApplyEditorValue();
            deactivate();
        }
