 ...
 * BUFFÑ¡Ôñ¡£
 */
public class BuffCellEditor extends CellEditor {
    protected Composite container;
    protected Text text;
    protected Button button;
    protected int buffID;

    public BuffCellEditor(Composite parent) {
    ...
    protected void doSetValue(Object value) {
        ...
        buffID = ((Integer)value).intValue();
        text.setText(BuffConfig.toString(EditorApplication.getProj(), buffID));
    }
    ...
    protected boolean dependsOnExternalFocusListener() {
        return getClass() != BuffCellEditor.class;
    }
    ...
    protected void editText() {
        ChooseBuffDialog dlg = new ChooseBuffDialog(text.getShell());
        dlg.setSelectedBuff(buffID);
        if (dlg.open() == Dialog.OK) {
            buffID = dlg.getSelectedBuff();
            text.setText(BuffConfig.toString(EditorApplication.getProj(), buffID));
            fireApplyEditorValue();
            deactivate();
        }
