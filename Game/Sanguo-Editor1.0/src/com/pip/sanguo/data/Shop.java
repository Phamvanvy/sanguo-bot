...
public class Shop extends DataObject {
     ...
     * 购买需求类型：声望
     */
    public static final int TYPE_REPUTATION = 10;
    
    public static final String[] TYPE_NAMES = {
        "money", "imoney", "honor", "rank", "item", "variable", "level", "consumecode", "exp", "salary", "reputation"
    };
    ...
    public static class BuyRequirement {
        ...
        public static String toString(List<BuyRequirement> list) {
            ...
            for (Shop.BuyRequirement req : list) {
                if ((req.type == Shop.TYPE_MONEY || req.type == Shop.TYPE_IMONEY || req.type == Shop.TYPE_HONOR || req.type == Shop.TYPE_EXP || req.type == Shop.TYPE_SALARY || req.type == Shop.TYPE_REPUTATION) && req.deduct) {
                    continue;
                }
                if (buf.length() > 0) {
                    buf.append(";");
