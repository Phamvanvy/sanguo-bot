...
//        long t = System.currentTimeMillis();
        oldMap = ("1".equals(elem.getAttributeValue("oldmap")));
...
//        System.out.println("timeall: " + (System.currentTimeMillis() - t));
    ...
    public Element save() throws Exception {
        ...
        elem.addAttribute("oldmap", oldMap ? "1" : "0");
     ...
     * @return
     */
    public static String locationToString1(ProjectData project, int[] location, boolean useVirtualCoord) {
        GameMapInfo mi = findByID(project, location[0]);
        if (mi == null) {
            return "未知场景";
        } else {
