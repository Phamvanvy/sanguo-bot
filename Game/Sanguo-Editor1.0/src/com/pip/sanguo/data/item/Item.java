...
public class Item extends DataObject {
     ...
     * 物品分类：随从召唤令
     */
    public static final int TYPE_ATTENDANT = 14;
    /**
     * 物品分类：坐骑礼包
     */
    public static final int TYPE_HORSE_PACKAGE = 15;
    
    /**
     * 物品分类：随从技能书
     */
    public static final int TYPE_ATTENDANT_SKILL = 16;
     ...
     * 物品分类2：装备物品
     */
    public static final int TYPE_ITEM_EQUIP = 1;
    
    /**
     * 物品分类2：宝石物品
     */
    public static final int TYPE_ITEM_JEWEL = 2;
     ...
     *  2:相对时效
     */
    public static final int TIME_TYPE_RELATIVELY = 1;
    
    /**
     * 时间类型
     *  1:绝对时效
     */
    public static final int TIME_TYPE_ABSOLUTELY = 2;
    
    /**
     * 装备升级消耗类型
     * 0-无消耗
     */
    public static final int EQUIPLEVELUP_TYPE_UNDEFINE = 0;
    
    /**
    * 装备升级消耗类型
    * 1-消耗战功
     */
    public static final int EQUIPLEVELUP_TYPE_CREDIT = 1;
    
    /**
     * 装备升级消耗类型
     * 2-消耗元宝
     */
    public static final int EQUIPLEVELUP_TYPE_IMONEY = 2;
    
    /**
     * 装备升级消耗类型
     * 2-消耗材料(目前固定材料ID)
     */
    public static final int EQUIPLEVELUP_TYPE_MATERIAL = 3;
    
    /***
     * 装备升级保留属性消耗类型
     * 1.元宝
     */
    public static final int SAVEEQUIPPROP_TYPE_UNDEFINE=0;
    public static final int SAVEEQUIPPROP_TYPE_IMONEY=1;
     ...
     * 技能图片--老
     */
    public static final int ICON_IMAGE_ABILITY = 0;
    
    /**
     * 技能图片--新增
     */
    public static final int ICON_IMAGE_ABILITY2 = 1;
     ...
     * 物品类型2
     */
    public int extraType = TYPE_NORMAL;
     ...
     * 3-材料
     */
    public int equipLevelUpPriceType;
    
    /***
     * 装备升级消耗数量
     */
    public int equipLevelUpPriceNum;
    
    /***
     * 装备升级保留属性类型
     * 
     */
    public int equipLevelUpSavePropType;

    /***
     * 保留属性消耗数量
     */
    public int equipLeveUpSavePropPriceNum;
    ...
    /**
     * 图标引用图片索引(0--ability, 1--ability新增)
     */
    ...
    public void load(Element elem) {
        ...
        try {
            extraType = Byte.parseByte(elem.getAttributeValue("extraType"));
        }
        catch (Exception e) {
            extraType = Item.TYPE_NORMAL;
        }
        ...
        try {
            iconImage = Integer.parseInt(elem.getAttributeValue("iconImage"));
        }
        ...
        try {
            produceArea = elem.getAttributeValue("producearea");
            if(produceArea==null)
                produceArea = "";
        }catch (Exception e2) {
            produceArea = "";
        ...
        if(available != AVAILABLE_NO){
            ...
            try{
                equipLevelUpPriceType=Integer.parseInt(elem.getAttributeValue("equipLevelUpPriceType"));
            }catch (Exception e){
                equipLevelUpPriceType=EQUIPLEVELUP_TYPE_UNDEFINE;
            }
            
            if(equipLevelUpPriceType!=EQUIPLEVELUP_TYPE_UNDEFINE){
                try{
                    equipLevelUpPriceNum=Integer.parseInt(elem.getAttributeValue("equipLevelUpPriceNum"));
                }catch (Exception e){
                    equipLevelUpPriceNum=0;
                }
            }
            
            try{
                equipLevelUpSavePropType=Integer.parseInt(elem.getAttributeValue("equipLevelUpSavePropType"));
            }catch (Exception e){
                equipLevelUpSavePropType=SAVEEQUIPPROP_TYPE_UNDEFINE;
            }
            
            if(equipLevelUpSavePropType!=SAVEEQUIPPROP_TYPE_UNDEFINE){
                try{
                    equipLeveUpSavePropPriceNum=Integer.parseInt(elem.getAttributeValue("equipLeveUpSavePropPriceNum"));
                }catch (Exception e){
                    equipLeveUpSavePropPriceNum=0;
                }
            }
            try {
    ...
    public Element save() {
        ...
        ret.addAttribute("extraType",String.valueOf(extraType));
        ...
        ret.addAttribute("iconImage",String.valueOf(iconImage));
        ...
        if(available != AVAILABLE_NO){
            ...
            ret.addAttribute("equipLevelUpPriceType",String.valueOf(equipLevelUpPriceType));
            if(equipLevelUpPriceType > EQUIPLEVELUP_TYPE_UNDEFINE){
                ret.addAttribute("equipLevelUpPriceNum",String.valueOf(equipLevelUpPriceNum));
            }
            ret.addAttribute("equipLevelUpSavePropType",String.valueOf(equipLevelUpSavePropType));
            if(equipLevelUpSavePropType > SAVEEQUIPPROP_TYPE_UNDEFINE){
                ret.addAttribute("equipLeveUpSavePropPriceNum",String.valueOf(equipLeveUpSavePropPriceNum));
            }
        ...
        ret.addAttribute("producearea", produceArea);
        return ret;
    }
    ...
    public void update(DataObject obj) {
        ...
        type = itemCopy.type;
        extraType = itemCopy.extraType;
        batchUseFlag = itemCopy.batchUseFlag;
        categoryName = itemCopy.categoryName;
        
        //sch
        nextEquipId=itemCopy.nextEquipId;
        canLevelUp=itemCopy.canLevelUp;
        equipLevelUpPriceNum=itemCopy.equipLevelUpPriceNum;
        equipLevelUpPriceType=itemCopy.equipLevelUpPriceType;
        
        equipLevelUpSavePropType=itemCopy.equipLevelUpSavePropType;
        equipLeveUpSavePropPriceNum=itemCopy.equipLeveUpSavePropPriceNum;
        //sch
        ...
        produceArea = itemCopy.produceArea;
    }
