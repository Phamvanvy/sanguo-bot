...
public class Equipment extends Item {
    ...
    public void load(Element elem) {
        ...
        limitType = Integer.parseInt(elem.getAttributeValue("limitType"));
        ...
        try {
            nextEquipId = Integer.parseInt(elem.getAttributeValue("nextEquipmentId"));
        } catch (Exception e) {
            nextEquipId = 0;
        }
        try {
        ...
        try {
            cardCount = Integer.parseInt(elem.getAttributeValue("cardcount"));
        } catch (Exception e) {
            holeCount = 1;
        }
        try {
            maxCardCount = Integer.parseInt(elem.getAttributeValue("maxcardcount"));
        } catch (Exception e) {
            maxCardCount = 1;
        }
        ...
        tmp = elem.getAttributeValue("canLevelUp");
        if(tmp==null){
            canLevelUp = false;
        }else{
            canLevelUp = "1".equals(tmp);
        }
...
//        }
    ...
    public Element save() {
        ...
        ret.addAttribute("limitType",String.valueOf(limitType));
        ...
        ret.addAttribute("canLevelUp",canLevelUp?"1":"0");//sch add
        ret.addAttribute("nextEquipmentId",String.valueOf(nextEquipId));
        
        ret.addAttribute("holecount",String.valueOf(holeCount));
        ret.addAttribute("maxholecount",String.valueOf(maxHoleCount));
        
        ret.addAttribute("cardcount",String.valueOf(cardCount));
        ret.addAttribute("maxcardcount",String.valueOf(maxCardCount));
    ...
    public void update(DataObject obj) {
        ...
        time = equi.time;
        equipLevelUpPriceType=equi.equipLevelUpPriceType;
        equipLevelUpPriceNum=equi.equipLevelUpPriceNum;
        equipLevelUpSavePropType=equi.equipLevelUpSavePropType;
        equipLeveUpSavePropPriceNum=equi.equipLeveUpSavePropPriceNum;
        holeCount = equi.holeCount;
        maxHoleCount = equi.maxHoleCount;
        cardCount = equi.cardCount;
        maxCardCount = equi.maxCardCount;
        canJudgeStar = equi.canJudgeStar;
        canJudgePotential = equi.canJudgePotential;
        canCopy = equi.canCopy;
        canLevelUp=equi.canLevelUp;
