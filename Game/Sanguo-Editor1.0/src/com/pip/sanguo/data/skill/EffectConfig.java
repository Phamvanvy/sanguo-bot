...
public abstract class EffectConfig implements Cloneable {
    ...
    public static final int ADD_FEARDEBUFF = 121;
    public static final int ADD_PARALYZEDEBUFF = 122;
    public static final int ADD_STAYDEBUFF = 123;
    public static final int ADD_DUMBDEBUFF = 124;
    public static final int FEAR_ADD_BUFF_OWNER = 125;
    public static final int PARALYZE_ADD_BUFF_OWNER = 126;
    public static final int STAY_ADD_BUFF_OWNER = 127;
    public static final int DUMB_ADD_BUFF_OWNER = 128;
    public static final int CHANGE_REWARD_RATE = 129;
    public static final int NOTEFFECT_MAP = 130;
    public static final int BUFFOVER_ADDBUFF = 131;
    public static final int DYNAMIC_CHANGE_PHYICAL_AP = 132;
    public static final int DYNAMIC_CHANGE_MAGIC_AP = 133;
    public static final int IGNORE_PHYSICS_IMMUNE = 134;
    public static final int IGNORE_MAGIC_IMMUNE = 135;
    public static final int CHANGE_PEOPLEEXP_RATE_BY_TONG_SKILL= 136;
    public static final int CHANGE_HRSEEXP_RATE_BY_TONG_SKILL= 137;
    public static final int RELIVE_MATE = 138;
    public static final int IGNORE_IGNORE_ARMOR = 139;
    public static final int IGNORE_IIGNORE_MAGIC_ARMOR = 140;
    public static final int ADD_PLAYER_JEWELENHANCE = 141;
    public static final int ADD_HORSE_JEWELENHANCE = 142;
    public static final int ATTENDANTONHIT_ADDBUFF_OWNER = 143;
    public static final int CHANGE_LASTTIME = 144;
    public static final int CHANGE_CRITED = 145;
    public static final int ANTI_DAMAGE = 146;
    ...
    public static final String[][] TYPE_NAMES = {
        ...
        { "恐惧", "恐惧" },              /* ADD_STARENHANCE */ 
        { "麻痹", "麻痹" },              /* ADD_STARENHANCE */ 
        { "定身", "定身" },              /* ADD_STARENHANCE */ 
        { "沉默", "沉默" },              /* ADD_STARENHANCE */ 
        { "被施加恐惧时给自己加BUFF", "恐惧" }, /* FEAR_ADD_BUFF_OWNER */
        { "被施加麻痹时给自己加BUFF", "麻痹" }, /* PARALYZE_ADD_BUFF_OWNER */
        { "被施加定身时给自己加BUFF", "定身" }, /* STAY_ADD_BUFF_OWNER */
        { "被施加沉默时给自己加BUFF", "沉默" }, /* DUMB_ADD_BUFF_OWNER */
        { "改变战功值获得速度", "战功" },             /* CHANGE_REWARD_RATE */
        { "限定不生效场景", "限定不生效场景" },              /* NOTEFFECT_MAP */  
        { "BUFF结束后给自己加BUFF", "添加BUFF" },  /* BUFFOVER_ADDBUFF */  
        { "动态改变物理攻击力", "物攻(1力2敏3智4体)" },  /* DYNAMIC_CHANGE_PHYICAL_AP */  
        { "动态改变法术攻击力", "法攻(1力2敏3智4体)" },  /* DYNAMIC_CHANGE_MAGIC_AP */  
        { "无视对方物理免伤","无视物理免伤"},/*IGNORE_PHYSICS_IMMUNE*/
        { "无视对方法术免伤","无视法术免伤"},/*IGNORE_MAGIC_IMMUNE*/
        { "军团技能影响人经验获取速度","军团技能影响人经验获取速度"},/*CHANGE_PEOPLEEXP_RATE_BY_TONG_SKILL*/
        { "军团技能影响马经验获取速度","军团技能影响马经验获取速度"},/*CHANGE_HRSEEXP_RATE_BY_TONG_SKILL*/
        { "复活目标(配偶)","复活"},                /* RELIVE_MATE */ 
        { "忽视无视护甲", "忽视无视护甲" },                    /* IGNORE_IGNORE_ARMOR */  
        { "忽视无视法术防御", "忽视无视法术防御" },            /* IGNORE_IIGNORE_MAGIC_ARMOR */  
        { "增加角色宝石镶嵌效果", "宝石增加幅度" },              /* ADD_PLAYERJEWELENHANCE */ 
        { "增加坐骑宝石镶嵌效果", "宝石增加幅度" },              /* ADD_HORSEJEWELENHANCE */ 
        { "随从释放技能命中目标后给主人加buff","给随从主人加buff"},/* ATTENDANTONHIT_ADDBUFF_OWNER*/
        { "修改持续时间","修改持续时间"},    /* CHANGE_LASTTIME*/
        { "修改并显示被暴击率","被暴击"},    /* CHANGE_CRITED*/
        { "时限几率免伤","免伤"},    /* ANTI_DAMAGE*/
    };
    public static final Class[] TYPE_CLASSES = {
        ...
        Effect_HP.class,
        Effect_HP.class,
        Effect_PercentAdd.class,                      /* FEAR */
        Effect_PercentAdd.class,                      /* PARALYZE */
        Effect_PercentAdd.class,                      /* STAY */
        Effect_PercentAdd.class,                      /* DUMB */
        Effect_AddBuff.class,                           /* FEAR_ADD_BUFF_OWNER */
        Effect_AddBuff.class,                           /* PARALYZE_ADD_BUFF_TARGET */
        Effect_AddBuff.class,                           /* PARALYZE_ADD_BUFF_OWNER */
        Effect_AddBuff.class,                           /* STAY_ADD_BUFF_TARGET */
        Effect_PercentAdd.class,                      /* CHANGE_REWARD_RATE */
        Effect_LimitMap.class,                      /* NOTEFFECT_MAP */ 
        Effect_AddBuff.class,                         /* BUFFOVER_ADDBUFF */ 
        Effect_MultiAdd.class,                        /* DYNAMIC_CHANGE_PHYICAL_AP */
        Effect_MultiAdd.class,                        /* DYNAMIC_CHANGE_MAGIC_AP */
        Effect_PercentAdd.class,                        /* IGNORE_PHYSICS_IMMUNE*/  
        Effect_PercentAdd.class,                        /* IGNORE_MAGIC_IMMUNE*/  
        Effect_PercentAdd.class,                        /* CHANGE_PEOPLEEXP_RATE_BY_TONG_SKILL */
        Effect_PercentAdd.class,                        /* CHANGE_HORSEEXP_RATE_BY_TONG_SKILL*/
        Effect_PercentAdd.class,                      /* RELIVE_MATE */  
        Effect_MultiAdd.class,                        /* IGNORE_IGNORE_ARMOR */  
        Effect_MultiAdd.class,                        /* IGNORE_IIGNORE_MAGIC_ARMOR */  
        Effect_PercentAdd.class,                      /* ADD_PLAYERJEWELENHANCE */
        Effect_PercentAdd.class,                      /* ADD_HORSEJEWELENHANCE */
        Effect_AddBuff.class,                         /*ATTENDANTONHIT_ADDBUFF_OWNER*/
        Effect_ChangeSpecialParam.class,              /* CHANGE_LASTTIME */
        Effect_PercentAdd.class,                      /* CHANGE_CRITED */
        Effect_AntiDamage.class,                      /* ANTI_DAMAGE */
    };
...
//        Effect_Shield.class,                          /* MP_SHIELD */  
        { "mp_shield_total", "mp_shield_dpercent", "mp_shield_percent", "mp_shield_price", "mp_shield_addpercent" },
//        Effect_Vampire.class,                         /* VAMPIRE_ON_HIT */ 
...
//      Effect_PercentAdd.class,                        /* ADD_STARENHANCE */ 
        ...
        { "stay_rate" },
        { "dumb_rate" },
//      Effect_AddBuff.class,                    
        { "fear_buff_rate", "add_debuff_rate_var", "fear_buff_id", "fear_buff_level" },
//      Effect_AddBuff.class,                   
        { "paralyz_buff_rate", "add_debuff_rate_var", "paralyz_buff_id", "paralyz_buff_level" },
//      Effect_AddBuff.class,                    
        { "stay_buff_rate", "add_debuff_rate_var", "stay_buff_id", "stay_buff_level" },
//      Effect_AddBuff.class,                   
        { "dumb_buff_rate", "add_debuff_rate_var", "dumb_buff_id", "dumb_buff_level" },
//      Effect_PercentAdd.class,                      /* CHANGE_REWARD_RATE */
        { "change_reward_rate" },
//      Effect_LimitMap.class,                      /* NOTEFFECT_MAP */  
        { "noteffct_map" },
//      Effect_AddBuff.class,                         /* BUFFOVER_ADDBUFF */ 
        { "add_buff_rate", "add_buff_rate_var", "add_buff_id", "add_buff_level" },
//      Effect_MultiAdd.class,                        /* DYNAMIC_CHANGE_PHYICAL_AP */
        { "dynamic_change_physical_ap_value", "dynamic_change_physical_ap_percent" },
//      Effect_MultiAdd.class,                        /* DYNAMIC_CHANGE_MAGIC_AP */
        { "dynamic_change_magic_ap_value", "dynamic_change_magic_ap_value_percent" },
//      Effect_PercentAdd.class,                        /* IGNORE_PHYSICS_IMMUNE */ 
        {"ignore_physics_percent" } , 
//      Effect_PercentAdd.class,                        /* IGNORE_MAGIC_IMMUNE*/ 
        {"ignore_magic_percent" }  ,
//      Effect_PercentAdd.class,                        /* CHANGE_PEOPLEEXP_RATE_BY_TONG_SKILL*/ 
        {"change_peopleexp_rate_by_tong_skill"},
//      Effect_PercentAdd.class,                        /* CHANGE_HORSEEXP_RATE_BY_TONG_SKILL*/ 
        {"change_horseexp_rate_by_tong_skill"},
//      Effect_PercentAdd.class,                      /* RELIVE_MATE */  
        { "relive_restore_percent" },
//      Effect_MultiAdd.class,                        /* IGNORE_ARMOR */
        { "ignore_ignore_armor_value", "ignore_ignore_armor_percent" },
//      Effect_MultiAdd.class,                        /* IGNORE_ARMOR */
        { "ignore_ignore_magic_armor_value", "ignore_ignore_magic_armor_percent" },
//      Effect_PercentAdd.class,                        /* ADD_PLAYERJEWELENHANCE */ 
        { "add_jewel_percent" },
//      Effect_PercentAdd.class,                        /* ADD_HORSEJEWELENHANCE */ 
        { "add_jewel_percent" },
//      Effect_AddBuff.class,                         /*ATTENDANTONHIT_ADDBUFF_OWNER*/ 
        { "add_debuff_hited_rate", "add_debuff_hited_rate_var", "add_debuff_hited_id", "add_debuff_hited_level" },
//      Effect_ChangeSpecialParam.class,                     /* CHANGE_LASTTIME */ 
        { "change_spcialparam_1", "change_spcialparam_percent_1",
          "change_spcialparam_2", "change_spcialparam_percent_2",
          "change_spcialparam_3", "change_spcialparam_percent_3",
          "change_spcialparam_4", "change_spcialparam_percent_4",
        },
//      Effect_PercentAdd.class,                        /* CHANGE_CRITED */ 
        { "change_crited" },
//      Effect_AntiDamage.class,                      /* ANTI_DAMAGE */
