...
public class Effect_Shield extends EffectConfig {
    ...
    private float[] spellHitRatio = new float[0];
    private float[] dpercent = new float[0];
    ...
    public void setLevelCount(int max) {
        ...
        spellHitRatio = Utils.realloc(spellHitRatio, max);
        dpercent = Utils.realloc(dpercent, max);
