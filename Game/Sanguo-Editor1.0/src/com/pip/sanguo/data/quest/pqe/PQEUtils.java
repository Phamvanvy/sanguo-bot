...
public class PQEUtils {
	...
	public static SystemVar[] SYSTEM_VARS = new SystemVar[] {
	    ...
	    new SystemVar("_IMONEY", 0, true, "元宝"),
	    ...
	    new SystemVar("_FOLLOWATTENDANT", 0, false, "是否携带随从"),
	};
    ...
    public static SystemFunc[] SYSTEM_FUNCS = new SystemFunc[] {
        ...
        new SystemFunc("E_FirstApproach", 0, false, new int[] { 0, 0, 0 }, "检测到玩家第一次接近 {0}:{1},{2}"),
        ...
        new SystemFunc("E_KillWithTeacher", 0, false, new int[] { 0, 1, 0 }, "检测到师徒一起杀死怪物 {0} "),
        ...
        new SystemFunc("Shout", 0, false, new int[] { 1 }, "狮子吼喊话"),
        new SystemFunc("E_KillPlayersLimited", 0, true, new int[] { 0, 0, 0 }, "防刷机制杀死玩家"),
        new SystemFunc("E_ReachPearls", 0, false, new int[] {0, 1, 0 }, "检测到玩家玩家达成连珠{0}"),
    };
