...
public class Log{
    ...
    public void process(){
        try{
            ...
            //处理playerId
            Matcher playerIdMatcher = define.getPlayerIdMatcher(printLog);
            if(playerIdMatcher.find()){
                playerId = Tools.getNumber(playerIdMatcher.group());
            }
            printLog = playerIdMatcher.replaceFirst("");
