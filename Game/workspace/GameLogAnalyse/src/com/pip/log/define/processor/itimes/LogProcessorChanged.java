...
public class LogProcessorChanged extends LogProcessor{
                ...
                for(int i = 0; i < count; i++){
                    ...
                    switch(type){
                        ...
                        case CHANGED_TYPE_REMOVED_PET: {
                            ...
                            int instanceId = dis.readInt();
                            String petName = dis.readUTF();
                            int petType = dis.readByte();
                            boolean isBaby = dis.readBoolean();
                            int petLevel = dis.readShort();
                            int petExp = dis.readInt();
                            int point = dis.readShort();
                            int currentPoint = dis.readShort();
                            int favor = dis.readByte();
                            int str = dis.readShort();
                            int agi = dis.readShort();
                            int vit = dis.readShort();
                            int intg = dis.readShort();
                            int hp = dis.readInt();
                            int mp = dis.readInt();
