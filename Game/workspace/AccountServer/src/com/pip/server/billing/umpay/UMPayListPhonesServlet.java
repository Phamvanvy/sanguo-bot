 ...
 *     如果失败，第二行是错误信息
 */
public class UMPayListPhonesServlet extends HttpServlet {
	private static Logger log = Logger.getLogger(UMPayListPhonesServlet.class);
	private UMPayDataDAO umpayDataDAO;
	private Server server;
	
	public UMPayListPhonesServlet(Server s, UMPayDataDAO dao) {
		server = s;
		umpayDataDAO = dao;
	}
