...
public class UWAPSocketStub implements IAccountServiceListener {
	...
	public static String QUICKREG_PREFIX = "�ο�";
		...
		private void rename(IoSession session,UWAPData data) throws Exception{
			...
			if (source != null) {
				...
				try{
					...
					if (numberStringValidator.valid(newName) == IStringValidator.OK) { // ������ע�ᴿ�����ʺ�
						if (phoneValidator.valid(newName) != IStringValidator.OK) //�������ֻ���ע��
...
//				try {
//
//					if (phoneValidator.valid(name) != IStringValidator.OK) // �������ֻ���ע��
//						throw new CreateAccountException(
//								Errors.ILLEGAL_NAME_CHAR);
//
...
//						throw new CreateAccountException(Errors.ILLEGAL_NAME_CHAR);
//					}
//					if(numberStringValidator.valid(name)!=IStringValidator.OK){ //������ע�ᴿ�����ʺ�
//						throw new CreateAccountException(Errors.ILLEGAL_NAME_CHAR);
//					}
				...
				if (source != null) {
					...
					if (source == null) {
						UWAPSegment seg = new UWAPSegment(
								...
								data.getSessionId());
						seg.writeString("serviceId��Ӧ��Source������");
						session.write(seg);
						session.close();
					} else {
