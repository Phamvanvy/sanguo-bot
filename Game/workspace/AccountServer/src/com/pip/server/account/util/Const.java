...
public class Const {
    ...
    public static final int UNIPAY_FEE_020 = 1 * IMONEY_RATE;    // 手机钱包2元续费，10元宝
    public static final int UNIPAY_FEE_080 = 4 * IMONEY_RATE;    // 手机钱包8元续费，40元宝
    public static final int UNIPAY_FEE_150 = 16 * IMONEY_RATE;   // 手机钱包15元续费
    public static final int UNIPAY_FEE_160 = 8 * IMONEY_RATE;    // 手机钱包16元续费，80元宝
//    public static final int UNIPAY_FEE_160 = 630000;    // 手机钱包16元续费，送1.5元
//    public static final int UNIPAY_FEE_300 = 303 * IMONEY_RATE / 10; 	// 手机钱包30元续费，送0.3元
    public static final int UNIPAY_FEE_300 = 150 * IMONEY_RATE / 10; 	// 手机钱包30元续费，150元宝
    public static final int UNIPAY_FEE_021_4REG = 1 * IMONEY_RATE;		//手机钱包注册赠送10元宝
...
//      "http://wap.monternet.com/reversesubscribe?SPID=900501&ServiceID=03202048&SPURL=http://wapdl.sina.com.cn/common/dlf/down.php?bid=4&from=wulin&chargeurl=http://<host>:<port>/WapFeeOk1?FeeID=";
    ...
    /** 2元计次产品描述 */
    public static final String UNIPAY_REMARK2 = "您购买的10个元宝已充入帐户%account%"; //"您购买的幻想i时代720i币已成功充入帐户%account%，请查收";
    /** 2元注册产品描述 */
    public static final String UNIPAY_REMARK2_2 = "您已成功注册幻想i时代帐户%account%，密码%password%";
    /** 2元找回密码产品描述 */
    public static final String UNIPAY_REMARK2_1 = "您的用户名是%account%，密码是%password%"; //"您的幻想i时代帐号是%account%，密码%password%";
    /** 2元修改绑定手机号产品描述 */
    public static final String UNIPAY_REMARK2_3 = "您的幻想i时代帐号%account%已绑定新号码%phone%";
    /** 15元计次产品描述 */
    public static final String UNIPAY_REMARK15 = "您已成为幻想i时代包月用户，当月游戏不再计时收费";
    /** 15元包月产品描述 */
    public static final String UNIPAY_REMARK151 = "恭喜您成为明珠优惠卡用户，当月游戏不再收取计时费用或享受消费9折的超值优惠"; //"您已成为幻想i时代包月用户，帐号%account%";
    /** 8元计次产品描述 */
    public static final String UNIPAY_REMARK8 = "您购买的40个元宝已充入帐户%account%"; //"您购买的幻想i时代2880i币已成功充入帐户%account%，请查收";
    /** 16元计次产品描述 */
    public static final String UNIPAY_REMARK16 = "您购买的80个元宝已充入帐户%account%"; //"您购买的幻想i时代6300i币已成功充入帐户%account%，请查收";
    /** 30元计次产品描述 */
    public static final String UNIPAY_REMARK30 = "您购买的150个元宝已充入帐户%account%"; //"您购买的幻想i时代6300i币已成功充入帐户%account%，请查收";
    /** 2元计次产品WAP下单地址 */
