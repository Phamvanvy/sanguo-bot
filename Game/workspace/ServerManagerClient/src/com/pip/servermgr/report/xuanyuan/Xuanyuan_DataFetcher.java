...
public class Xuanyuan_DataFetcher implements DataFetcher {
	...
	public void run() {
		try {
			...
			while (start < count) {
				...
				sql = "select id, accountid, name, mapid, x, y, level, exp, sex, faction, tong, money, skillPoint, skillExp, lastLoginTime, " +
					"lastLogoutTime, createTime, tongMoney, exist, horsebag, petbag, agility, strength, stamina, intellect, propertypoint, " +
					"restSkillPoint, formulas, bags, skills, equs, tasks from player where " +
