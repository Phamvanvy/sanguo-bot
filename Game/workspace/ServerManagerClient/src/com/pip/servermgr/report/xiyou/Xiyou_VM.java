...
public class Xiyou_VM {
	...
	public static Xiyou_VM parse(byte[] bytes) throws IOException {
		Xiyou_VM ret = new Xiyou_VM();
	...
	protected static void fromDBBytes(DataInputStream dis, Xiyou_VM vm) throws IOException {
