...
public class MZX_VM {
	...
	public static MZX_VM parse(byte[] bytes) throws IOException {
		MZX_VM ret = new MZX_VM();
	...
	protected static void fromDBBytes(DataInputStream dis, MZX_VM vm) throws IOException {
