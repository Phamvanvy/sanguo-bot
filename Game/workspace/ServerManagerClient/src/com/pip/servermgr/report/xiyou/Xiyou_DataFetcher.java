...
public class Xiyou_DataFetcher implements DataFetcher {
	...
	public void run() {
		try {
			...
			while (start < count) {
				...
				sql = "select id, accountid, name, mapid, x, y, level, exp, sex, propertypoint, money, bags, faction, equs, exist, " + 
					"magicBag, skills, petBag, opBarConf, skillPoint, questVm, holeName, honour, actionPoint, ability, reputation, " +
					"formulaList, pool, lastLoginTime, createTime, boundIMoney, flyingItem, equipBar, designations, storeHouses, " +
					"interalCount, integral, yuanyingLevel from player where " +
