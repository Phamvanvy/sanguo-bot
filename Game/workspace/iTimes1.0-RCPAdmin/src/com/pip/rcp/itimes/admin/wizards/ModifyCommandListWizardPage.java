...
public class ModifyCommandListWizardPage extends WizardPage{
    ...
    public ModifyCommandListWizardPage(){
        super("修改命令");
        setTitle("请修改命令信息");
        setDescription("");
    }
    ...
    public void createControl(Composite p){
        ...
        lstParms = new List(container, SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER);
    ...
    private void updateData(){
        ...
        txName.setText(commandData.getName());
        txCommand.setText(commandData.getCommand());
        cbConfirm.select(commandData.isNeedConfirm()? 1: 0);
