 ...
 */
public class GTLAutoIndentStrategy extends DefaultIndentLineAutoEditStrategy {

	public GTLAutoIndentStrategy() {
	}
	 ...
	 */
	 protected void smartIndentAfterNewLine(IDocument document, DocumentCommand command) {
		...
		try {
			...
			System.out.println(GTLEditorMessages.getString("AutoIndent.error.bad_location_1")); //$NON-NLS-1$
		}
	}
	 ...
	 */
	 protected void smartInsertAfterBracket(IDocument document, DocumentCommand command) {
		...
		try {
			...
			System.out.println(GTLEditorMessages.getString("AutoIndent.error.bad_location_2")); //$NON-NLS-1$
		}
	}
}
