...
public class GTLCodeScanner extends RuleBasedScanner implements GTLEditorParserListener {
	...
	private static String[] fgKeywords= { "this", "define", "library", "include", "break", "continue", "else", "if", "while", "LIBRARY", "VERSION", "ID", "ATTRIBUTE", "NAME", "DESCRIPTION", "DATA", "return", "FUNCTION", "CALLBACK", "new", "free", "STRUCT", "extends", "for", "switch", "case", "default", "instanceof" }; //$NON-NLS-36$ //$NON-NLS-35$ //$NON-NLS-34$ //$NON-NLS-33$ //$NON-NLS-32$ //$NON-NLS-31$ //$NON-NLS-30$ //$NON-NLS-29$ //$NON-NLS-28$ //$NON-NLS-27$ //$NON-NLS-26$ //$NON-NLS-25$ //$NON-NLS-24$ //$NON-NLS-23$ //$NON-NLS-22$ //$NON-NLS-21$ //$NON-NLS-20$ //$NON-NLS-19$ //$NON-NLS-18$ //$NON-NLS-17$ //$NON-NLS-16$ //$NON-NLS-15$ //$NON-NLS-14$ //$NON-NLS-13$ //$NON-NLS-12$ //$NON-NLS-11$ //$NON-NLS-10$ //$NON-NLS-9$ //$NON-NLS-8$ //$NON-NLS-7$ //$NON-NLS-6$ //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$

	private static String[] fgTypes= { "boolean", "byte", "int", "short", "String", "Sprite", "ImageSet", "Stream", "UWAPSegment", "Vector", "Hashtable", "Object" }; //$NON-NLS-1$ //$NON-NLS-5$ //$NON-NLS-7$ //$NON-NLS-6$ //$NON-NLS-8$ //$NON-NLS-9$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-2$
	...
	private void createDefaultKeywordsRule(WordRule rule) {
        ...
        String[] funcs = GTLFunctionCallGenerator.listSystemFunctions();
