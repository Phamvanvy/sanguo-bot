...
public class HttpSession implements IoSession {
    ...
    private final static boolean[] NOTIFY = {false,true,false,true,false,true,false,true,false,true,
    ...
    private boolean has90 = false;

    public HttpSession(HttpAcceptor acceptor,SocketAddress address){
    ...
    public WriteFuture write(Object message) {
        synchronized (this) {
            byte type = ((UWAPSegment) message).getType();
            if(type==90&&has90){
                return null;
            }else{
    ...
    public UWAPSegment[] getSegments(){
        synchronized(this){
            UWAPSegment[] ret = new UWAPSegment[messages.size()];
