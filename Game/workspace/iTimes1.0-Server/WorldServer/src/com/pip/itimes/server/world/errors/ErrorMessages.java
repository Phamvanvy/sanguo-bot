package com.pip.itimes.server.world.errors;
...
public class ErrorMessages {
    ...
    public static final String ILLEGAL_SESSIONID_MESSAGE = "登录会话已失效，请退出游戏重新登陆";

    public static final int NOT_ENOUGH_BALANCE = 5;
    public static final String NOT_ENOUGH_BALANCE_MESSAGE = "没有足够的" + Server.iMoneyString + ",请及时充值";
    ...
    public static final String NOT_ENOUGH_TRUST_BALANCE_MESSAGE = "可用余额不足(某些充值渠道,例如苹果商店支付,兑换的i币无法购买非绑定道具)";
