 ...
 * @version 1.0
 */
public class Ai90002_3 extends BaseMonsterAI{

    public static final IItem life = Items.getTemplate(3).newInstance(); //´óÉúÃüÒ©¼Á
    public static final Ability ability = Ability.getAbility(5); //çÍ·×Á¬»÷5
    ...
    public boolean action(BattleSprite bs, int index, BattleSprite[] our,
        ...
        if(!bs.canAction()){
            ...
            if(Utils.hit(rnd,40,100)&&bs.mp>=ability.getMpUse(bs.level, bs.mp)){
