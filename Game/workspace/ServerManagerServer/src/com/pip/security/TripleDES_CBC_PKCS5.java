...
public class TripleDES_CBC_PKCS5 {
     ...
     */
    public TripleDES_CBC_PKCS5() throws Exception {
...
// ...................................................................
    ...
    private DES_CBC_PKCS5 des1 = new DES_CBC_PKCS5(), des2 = new DES_CBC_PKCS5(),
        des3 = new DES_CBC_PKCS5();
...
// ...................................................................
               ...
               byte[] output, int outputOffset)
    {
        if(decrypt) {
            int ret = 0;
            int remainder;
            while(inputLen >= (remainder = BLOCK_SIZE - bufCount)) {
            ...
            while(inputLen >= (remainder = BLOCK_SIZE - bufCount)) {
                ...
                coreCrypt(buf, 0, buf, 0);
                System.arraycopy(buf, 0, output, outputOffset, BLOCK_SIZE);
                inputLen     -= remainder;
